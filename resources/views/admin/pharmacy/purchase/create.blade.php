            ...
            <div class="card-header" style="background: linear-gradient(-90deg, #75009673 0%, #CB6CE673 100%)">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-end">
                        <span style="color: #750096"><strong>Purchase Date:</strong> {{ now()->format('m/d/Y g:i A') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                @if(isset($categories))
                    <div class="alert alert-info">
                        <strong>Debug:</strong> Categories loaded: {{ $categories->count() }} categories found
                        <br>Categories: 
                        @foreach($categories as $cat)
                            {{ $cat->medicine_category }}{{ !$loop->last ? ', ' : '' }}
                        @endforeach
                    </div>
                @else
                ...
                <form action="{{ route('pharmacy.purchase.store') }}" method="POST" id="purchaseForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="{{ route('pharmacy.purchase.index') }}" class="btn btn-secondary">Cancel</a>
