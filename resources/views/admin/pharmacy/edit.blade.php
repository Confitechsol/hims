{{-- resources/views/admin/pharmacy/edit.blade.php --}}
                        ...
                        <div class="row">
                                ...
                                <select name="medicine_company" class="form-select">
                                    ...
                                    @foreach($companies as $company)
                                        <option value="{{ $company->id }}" 
                                            {{ old('medicine_company', $medicine->medicine_company) == $company->id ? 'selected' : '' }}>
                                ...
                                <select name="medicine_group" class="form-select">
                                    ...
                                    @foreach($groups as $group)
                                        <option value="{{ $group->id }}" 
                                            {{ old('medicine_group', $medicine->medicine_group) == $group->id ? 'selected' : '' }}>
                                            {{ $group->group_name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="unit" class="form-select">
                                    ...
                                    @foreach($units as $unit)
                                        <option value="{{ $unit->id }}" 
                                            {{ old('unit', $medicine->unit) == $unit->id ? 'selected' : '' }}>
                                            {{ $unit->unit_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="gst_percentage" class="form-select">
                                    ...
                                    <option value="0" {{ old('gst_percentage', $medicine->gst_percentage) == '0' ? 'selected' : '' }}>0% (Exempt)</option>
                                    <option value="5" {{ old('gst_percentage', $medicine->gst_percentage) == '5' ? 'selected' : '' }}>5%</option>
                                    <option value="12" {{ old('gst_percentage', $medicine->gst_percentage) == '12' ? 'selected' : '' }}>12%</option>
                                    <option value="18" {{ old('gst_percentage', $medicine->gst_percentage) == '18' ? 'selected' : '' }}>18%</option>
                                    <option value="28" {{ old('gst_percentage', $medicine->gst_percentage) == '28' ? 'selected' : '' }}>28%</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="unit_packing" class="form-control" 
                                       value="{{ old('unit_packing', $medicine->unit_packing) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="rack_number" class="form-control" 
                                       value="{{ old('rack_number', $medicine->rack_number) }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="is_active" class="form-select">
                                    <option value="yes" {{ old('is_active', $medicine->is_active) == 'yes' ? 'selected' : '' }}>Active</option>
                                    <option value="no" {{ old('is_active', $medicine->is_active) == 'no' ? 'selected' : '' }}>Inactive</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="note" class="form-control" rows="3">{{ old('note', $medicine->note) }}</textarea>
                            </div>
                        </div>
