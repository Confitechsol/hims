                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <x-table-actions.actions id="department" name="Department" />
                                            ...
                                            <tbody>
                                                @foreach ($departments as $department)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form
                                                                action="{{ route('department.updateStatus', [$department->id]) }}"
                                                                method="post">
                                                                @csrf
                                                                <div class="form-check form-switch mb-0">
                                                                    <input class="form-check-input status-toggle"
                                                                        ...
                                                                        {{ $department->is_active == 'yes' ? 'checked' : '' }}>
                                                                </div>
                                                            </form>
                                                        </td>
                                                        <td>
                                                            ...
                                                            <form
                                                                ...
                                                                class="d-inline" id="delete-form-{{ $department->id }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <a href="javascript: void(0);"
                                                                    ...
                                                                    data-form-id="delete-form-{{ $department->id }}">
                                    ...
                                    <div class="mt-3" id="pagination-wrapper">
                                        ...
                                        @else
                                            <a href="{{ $departments->previousPageUrl() }}{{ request('perPage') ? '&perPage=' . request('perPage') : '' }}"
                                        ...
                                        @for ($page = 1; $page <= $lastPage; $page++)
                                            ...
                                            @else
                                                <a href="{{ $departments->url($page) }}{{ request('perPage') ? '&perPage=' . request('perPage') : '' }}"
                                                    class="btn btn-outline-secondary btn-sm me-1">
                                                    {{ $page }}
                                                </a>
                                            @endif
                                        ...
                                        @if ($departments->hasMorePages())
                                            <a href="{{ $departments->nextPageUrl() }}{{ request('perPage') ? '&perPage=' . request('perPage') : '' }}"
