                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <x-table-actions.actions id="dosage-duration" name="Dosage Duration" /> 
...
<x-modals.form-modal type="add" id="createModal" title="Add Dosage Duration"
