                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('item-category.store') }}"
                                                                method="POST">
                                                                @csrf
                                            ...
                                            <tbody>
                                                @foreach ($itemCategories as $itemCategory)
                                                    <tr>
                                                        ...
                                                        <td>{{ $itemCategory->item_head ?? '-' }}</td>
                                                        <td class="text-wrap">{{ $itemCategory->description }}</td>
                                                        <td>
                                                            <form
                                                                action="{{ route('item-category.updateStatus', [$itemCategory->id]) }}"
                                                                method="post">
                                                                @csrf
                                                                <div class="form-check form-switch mb-0">
                                                                    <input class="form-check-input status-toggle"
                                                                        ...
                                                                        {{ $itemCategory->is_active == 'yes' ? 'checked' : '' }}>
                                                                </div>
                                                            </form>
                                                        </td>
                                                        <td>
                                                            <a href="javascript: void(0);"
                                                                ...
                                                                data-id="{{ $itemCategory->id }}"
                                                                data-name="{{ $itemCategory->item_category }}"
                                                                data-head="{{ $itemCategory->item_head }}"
                                                                data-description="{{ $itemCategory->description }}">
                                                                <i class="ti ti-pencil"></i></a>
                                                            <form
                                                                action="{{ route('item-category.delete', [$itemCategory->id]) }}"
                                                                class="d-inline" id="delete-form-{{ $itemCategory->id }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <a href="javascript: void(0);"
                                                                    class="fs-18 p-1 btn btn-icon btn-sm btn-soft-danger rounded-pill delete-button"
                                                                    data-item-category-id="{{ $itemCategory->id }}"
                                                                    data-item-category-name="{{ $itemCategory->item_category }}"
                                                                    data-form-id="delete-form-{{ $itemCategory->id }}">
                                    ...
                                    <div class="modal fade" id="edit_itemCategory" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('item-category.update') }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div id="item_category_fields">
