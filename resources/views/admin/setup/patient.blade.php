                                                                ...
                                                                <div class="row gy-3">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <select name="marital_status"
                                                                                    ...
                                                                                    <option value="Separated" {{ old('marital_status') == 'Separated' ? 'selected' : '' }}>Separated
                                                                                    </option>
                                                                                    <option value="Not Specified" {{ old('marital_status') == 'Not Specified' ? 'selected' : '' }}>Not
                                                                                        Specified</option>
                                                                                </select>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <select name="tpa"
                                                                            ...
                                                                            <option value="">Select</option>
                                                                            <option value="5" {{ old('tpa') == '5' ? 'selected' : '' }}>MedoLogi TPA Pvt. Ltd.
                                                                            </option>
                                                                            <option value="4" {{ old('tpa') == '4' ? 'selected' : '' }}>Vidal Health TPA</option>
                                                                            <option value="3" {{ old('tpa') == '3' ? 'selected' : '' }}>Paramount Health Services
                                                                            </option>
                                                                            <option value="2" {{ old('tpa') == '2' ? 'selected' : '' }}>Raksha TPA Pvt. Ltd.
                                                                            </option>
                                                                            <option value="1" {{ old('tpa') == '1' ? 'selected' : '' }}>MediAssist TPA Pvt. Ltd.
                                                                            </option>
                                                                        </select>
                                                                        @error('tpa')
                                                                            <div class="invalid-feedback">{{ $message }}</div>
