                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <x-table-actions.actions id="symptoms_type" name="Symptoms Type" />
    ...
    @endforeach
                                   ...
                                   {{-- Pagination Links --}}
                                    <div class="mt-3" id="pagination-wrapper">
                                        @php
                                            $currentPage = $symptomTypes->currentPage();
                                            $lastPage = $symptomTypes->lastPage();
                                        @endphp

                                        {{-- Previous --}}
                                        @if ($symptomTypes->onFirstPage())
                                            <button class="btn btn-outline-secondary btn-sm me-1" disabled>« Prev</button>
                                        @else
                                            <a href="{{ $symptomTypes->previousPageUrl() }}{{ request('perPage') ? '&perPage=' . request('perPage') : '' }}"
                                        ...
                                        @for ($page = 1; $page <= $lastPage; $page++)
                                            ...
                                            @else
                                                <a href="{{ $symptomTypes->url($page) }}{{ request('perPage') ? '&perPage=' . request('perPage') : '' }}"
                                                    class="btn btn-outline-secondary btn-sm me-1">
                                                    {{ $page }}
                                                </a>
                                            @endif
                                        ...
                                        {{-- Next --}}
                                        @if ($symptomTypes->hasMorePages())
                                            <a href="{{ $symptomTypes->nextPageUrl() }}{{ request('perPage') ? '&perPage=' . request('perPage') : '' }}"
