...
@section('content')
            ...
            <div class="card shadow-sm border-0 mt-4">
                <div class="card-header" style="background: linear-gradient(-90deg, #75009673 0%, #CB6CE673 100%)">
                    <h5 class="mb-0" style="color: #750096">
                        <i class="fas fa-cogs me-2"></i> Import Medicines
                    </h5>
                </div>
                                ...
                                <div class="card-body">
                                    <div
                                        ...
                                        <div class="page_btn d-flex">
                                            ...
                                            <div class="text-end d-flex">
                                                <a href="{{ route('medicineMaster.export') }}"
                                    ...
                                    <div id="guidelinesBox" class="guidelines-box">
                                        <div class="example_txt card p-3 shadow-sm">
                                            <ol>
                                                <li class="mb-2">
                                                    Your CSV data should follow the sample format. The first row must
                                                ...
                                                <li class="mb-2">
                                                    For numeric fields such as <strong>Price / Amount</strong>,
                                                    use numbers only.
                                                </li>
                                            </ol>
                                        </div>
                                    ...
                                    <div class="import_form">
                                        <form action="{{ route('medicineMaster.import') }}" method="POST"
                                            ...
                                            <button type="submit" class="btn btn-primary ms-auto d-block mt-3">
                                                <i class="fa-solid fa-cloud-arrow-up"></i> Import Medicines
                                            </button>
    ...
    <script>
        ...
        function exportToCSV() {
            ...
            link.download = 'medicineMaster.csv';
            link.click();
        }
    </script>
