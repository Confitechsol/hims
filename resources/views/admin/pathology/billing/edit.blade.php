                                ...
                                <table class="table table-bordered" id="testTable">
                                    ...
                                    <tbody id="testTableBody">
                                        ...
                                        <tr class="test-row">
                                                    ...
                                                    @if(isset($tests) && count($tests) > 0)
                                                        @foreach($tests as $test)
                                                            <option value="{{ $test->id }}" 
                                                                ...
                                                                {{ $report->pathology_id == $test->id ? 'selected' : '' }}>
                                            ...
                                            <td>
                                                <input type="number" name="tests[{{ $index }}][report_days]" class="form-control report_days" value="{{ $report->pathology->report_days ?? 0 }}" min="0" readonly>
                                            </td>
                                            <td>
