            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="editOpdForm" action="{{ route('opd.update', [$opd->id]) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                            ...
                                            <div class="form-row cols-3">
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <input type="text" name="symptoms_description"
                                                        ...
                                                        value="{{ old('symptoms_description', $opd->symptoms_description) }}"
                                            ...
                                            <div class="form-row cols-2">
                                                <div class="field-group">
                                                    ...
                                                    <input type="date" name="appointment_date" id="appointment_date"
                                                        class="form-control"
                                                        value="{{ old('appointment_date', $opd->appointment_date) }}"
                                                        required>
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <select name="old_patient" id="old_patient" class="form-select">
                                                        ...
                                                        <option value="Old Patient"
                                                            {{ old('old_patient', $opd->case_type ?? '') == 'Old Patient' ? 'selected' : '' }}>
                                                            Old Patient</option>
                                                        <option value="New Patient"
                                                            {{ old('old_patient', $opd->case_type ?? '') == 'New Patient' ? 'selected' : '' }}>
                                                            New Patient</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <select name="casualty" id="casualty" class="form-select">
                                                        <option value="">Select</option>
                                                        <option value="No"
                                                            {{ old('casualty', $opd->casualty ?? '') == 'No' ? 'selected' : '' }}>
                                                            No</option>
                                                        <option value="Yes"
                                                            {{ old('casualty', $opd->casualty ?? '') == 'Yes' ? 'selected' : '' }}>
                                                            Yes</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <input type="text" name="reference" id="reference"
                                                        class="form-control"
                                                        value="{{ old('reference', $opd->reference) }}"
                                                    ...
                                                    <select name="consultant_doctor" id="consultant_doctor"
                                                        ...
                                                        @foreach ($doctors as $doctor)
                                                            <option value="{{ $doctor->id }}"
                                                                {{ old('consultant_doctor', $opd->doctor_id ?? '') == $doctor->id ? 'selected' : '' }}>
                                                                {{ $doctor->name }}
                                                            </option>
                                                        @endforeach
                                            ...
                                            <div class="form-row cols-2">
                                                <div class="field-group">
                                                    ...
                                                    <input type="date" name="payment_date" id="payment_date"
                                                        class="form-control"
                                                        value="{{ old('payment_date', $opd->payment_date) }}" required>
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <select name="payment_mode" id="payment_mode" class="form-select">
                                                        ...
                                                        <option value="Cash"
                                                            {{ old('payment_mode', $opd->payment_mode ?? '') == 'Cash' ? 'selected' : '' }}>
                                                            Cash</option>
                                                        <option value="Card"
                                                            {{ old('payment_mode', $opd->payment_mode ?? '') == 'Card' ? 'selected' : '' }}>
                                                            Card</option>
                                                        <option value="UPI"
                                                            {{ old('payment_mode', $opd->payment_mode ?? '') == 'UPI' ? 'selected' : '' }}>
                                                            UPI</option>
                                                        <option value="Net Banking"
                                                            {{ old('payment_mode', $opd->payment_mode ?? '') == 'Net Banking' ? 'selected' : '' }}>
                                                            Net Banking</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="section-body">
                                            <div class="form-row cols-2">
                                                <div class="field-group">
                                                    ...
                                                    <textarea name="note" id="note" class="form-control" placeholder="Enter notes" rows="4">{{ old('note', $opd->note) }}</textarea>
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <textarea name="known_allergies" id="known_allergies" class="form-control" placeholder="Enter known allergies"
                                                        rows="4">{{ old('known_allergies', $opd->allergies) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
