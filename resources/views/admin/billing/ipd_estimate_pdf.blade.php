...
<body>
    ...
    <main>
        ...
        <table class="charges-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">Rs. {{ number_format((float) ($charge->standard_charge ?? 0), 2) }}</td>
                    <td>{{ $charge->qty }}</td>
        ...
        @include('admin.billing.partials.ipd_ot_doctor_charges_table')
        @include('admin.billing.partials.ipd_doctor_visit_charges_table')

        @include('admin.billing.partials.ipd_payment_details_table')
        ...
        <div class="summary-section">
            ...
            <div class="summary-row">
                ...
                <span class="summary-value">Rs. {{ number_format($breakup['package_charges'], 2) }}</span>
            </div>
            @endif
