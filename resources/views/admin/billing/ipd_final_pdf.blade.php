            ...
            <table style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="text-align: center; width: 25%; padding: 4px 5px;">
                        <strong>Bill No.</strong> : <span class="red">{{ $billNumber ?? 'F-' . str_pad($ipd->id, 6, '0', STR_PAD_LEFT) . '/' . date('y') . '-' . (date('y') + 1) }}</span>
                    </td>
                    <td style="text-align: center; width: 25%; padding: 4px 5px;">
                        <strong>Bill Date</strong> : {{ $dischargeDate ? \Carbon\Carbon::parse($dischargeDate)->format('d/m/Y') : (\Carbon\Carbon::parse($billDate)->format('d/m/Y')) }}
                    </td>
                    ...
                    <td style="width: 50%; vertical-align: top; padding-right: 15px;">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td class="patient_value">{{ strtoupper($ipd->patient->patient_name ?? 'N/A') }}@if($ipd->patient && $ipd->patient->organisation) ({{ strtoupper($ipd->patient->organisation->organisation_name ?? '') }})@endif</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="patient_colon">:</td>
                                <td class="patient_value">{{ ($ipd->patient && $ipd->patient->police_station) ? $ipd->patient->police_station : 'N/A' }}</td>
                            </tr>
                            <tr>
                                <td class="patient_label">Phone No.</td>
                                <td class="patient_colon">:</td>
                                <td class="patient_value">{{ $ipd->patient && $ipd->patient->mobileno ? $ipd->patient->mobileno : 'N/A' }}</td>
                            </tr>
                            @if($ipd->doctor)
                            <tr>
                    ...
                    <td style="width: 50%; vertical-align: top; padding-left: 15px;">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td class="patient_colon">:</td>
                                <td class="patient_value">{{ ($ipd->patient && $ipd->patient->age) ? $ipd->patient->age . ' Y' : 'N/A' }}</td>
                            </tr>
                            <tr>
                                <td class="patient_label">Sex</td>
                                <td class="patient_colon">:</td>
                                <td class="patient_value">{{ $ipd->patient ? strtoupper($ipd->patient->gender ?? 'N/A') : 'N/A' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="patient_colon">:</td>
                                <td class="patient_value"><span class="red">{{ \Carbon\Carbon::parse($dischargeDate)->format('d/m/Y') }}</span></td>
                            </tr>
                            @if(isset($dischargeTime) && $dischargeTime)
                            <tr>
