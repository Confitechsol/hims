                    ...
                    <div class="card shadow-sm flex-fill w-100">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-sm-center justify-content-between flex-wrap gap-2 w-100">
                                <div>
                                    <h4 class="fw-bold mb-0">OPD Billing</h4>
                                </div>
                                                            ...
                                                            <div class="row gy-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-check d-flex gap-2">
                                                                        <input type="checkbox" name="tpa_check"
                                                                            id="tpa_check" class="form-check-input">
                                                                        <label for="tpa_check"
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text"
                                                                            class="form-control discount_percentage"
                                                                            name="tax" id="tax" value="0" autocomplete="off"
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" readonly="true" name="amount"
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fs-14 mb-1"><a href="patient-profile"
                                                        class="fw-semibold">Shreya Bhattacharyya</a></h6>
                                            </td>
