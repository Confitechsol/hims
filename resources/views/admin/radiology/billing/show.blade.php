        ...
        <div class="card shadow-sm border-0 mt-4">
            <div class="card-header" style="background: linear-gradient(-90deg, #75009673 0%, #CB6CE673 100%)">
                <h5 class="mb-0" style="color: #750096">
                    <i class="fas fa-eye me-2"></i>Radiology Bill Details
                </h5>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <a href="{{ route('radiology.billing.index') }}" class="btn btn-secondary">
                            <i class="ti ti-arrow-left me-1"></i>Back to List
                        </a>
                    </div>
                    <div class="col-md-6 text-end">
                        <a href="{{ route('radiology.billing.edit', $bill->id) }}" class="btn btn-warning text-white me-2">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $report->radiology->test_name ?? '-' }}</td>
                                        <td>{{ $report->radiology->report_days ?? '-' }}</td>
