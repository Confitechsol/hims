                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <button class="btn btn-success" onclick="exportToExcel('ipd-balance-report-table')">Export to Excel</button>
                                            <button class="btn btn-danger" onclick="exportToPDF('ipd-balance-report-table')">Export to PDF</button>
                                            ...
                                            <div class="table-responsive table-nowrap">
                                                <table class="table border" id="ipd-balance-report-table">
