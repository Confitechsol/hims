...
@section('content')
    ...
    <div class="p-4">
        ...
        <ul class="nav nav-tabs nav-bordered mb-3">
            ...
            <li class="nav-item">
                <a href="#operations" data-bs-toggle="tab" aria-expanded="true" class="nav-link bg-transparent"><i
                        class="fa-solid fa-scissors text-primary"></i>
                    <span>Operations</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="#charges" data-bs-toggle="tab" aria-expanded="true" class="nav-link bg-transparent"><i
                        class="fa-solid fa-circle-dollar-to-slot text-primary"></i>
                    <span>Charges</span>
                </a>
            </li>
            <li class="nav-item">
