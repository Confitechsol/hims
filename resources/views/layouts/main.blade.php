...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('assets//medical/img/favicon.ico') }}">
    <!-- Bundle -->
    <link rel="stylesheet" href="{{ asset('assets/styles/css/bundle.min.css') }}">
    <!-- Plugin Css -->
    <link rel="stylesheet" href="{{ asset('assets/styles/css/revolution-settings.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/styles/css/jquery.fancybox.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/styles/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/styles/css/swiper.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/styles/css/cubeportfolio.min.css') }}">
    <!-- Style Sheet -->
    <link rel="stylesheet" href="{{ asset('assets/styles/css/select2.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/styles/css/jquery-ui.bundle.css') }}">
    ...
    <style>
        ...
        .chatbot-button {
            ...
            z-index: 9998;
            background-image: url("{{ asset('assets/medical/img/hbot.png') }}");
            background-size: 50%;
        ...
        .chatbot-button.active {
            background-image: url("{{ asset('assets/medical/img/delete.png') }}");
            /* Example: close icon */
        }
...
<script src="{{ asset('assets/styles/js/bundle.min.js') }}"></script>

<!-- Plugin Js -->
<script src="{{ asset('assets/styles/js/jquery.fancybox.min.js') }}"></script>
<script src="{{ asset('assets/styles/js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('assets/styles/js/swiper.min.js') }}"></script>
<script src="{{ asset('assets/styles/js/jquery.cubeportfolio.min.js') }}"></script>
<script src="{{ asset('assets/styles/js/jquery.appear.js') }}"></script>
<script src="{{ asset('assets/styles/js/hover-item.js') }}"></script>
<script src="{{ asset('assets/styles/js/isotope.pkgd.min.js') }}"></script>
<!-- REVOLUTION JS FILES -->
