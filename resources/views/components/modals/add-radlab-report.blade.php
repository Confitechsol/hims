...
<div class="modal fade" id="addRadioLabModal" tabindex="-1" aria-labelledby="addRadioLabModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl ">
        <div class="modal-content" style="overflow: visible;">
            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="addRadioLabModalLabel">
            ...
            @endif
            <form action="{{ route('ipd.updateRadioReport', $lab->id) }}" id="prescriptionForm" method="post" enctype="multipart/form-data">@csrf
                @csrf
