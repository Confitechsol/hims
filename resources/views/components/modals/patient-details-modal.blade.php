                ...
                <div class="patient-info-section">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="patient_name_value">{{ $patient->patient_name ?? '-' }}</div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="gender_value">{{ $patient->gender ?? '-' }}</div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="age_value">
                                {{ $patient->age . ' Year ' . $patient->month . ' Month ' . $patient->day . ' Days' ?? '-' }}
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="marital_value">{{ $patient->marital_status ?? '-' }}</div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="blood_grp_value">{{ $patient->bloodGroup->name ?? '-' }}</div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="phone_value">{{ $patient->mobileno ?? '-' }}</div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="address_value">{{ $patient->address ?? '-' }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="patient-info-section">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="tpa_value">{{ $patient->organisation->organisation_name ?? '-' }}</div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="tpa_code_value">{{ $patient->organisation->code ?? '-' }}</div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="tpa_validity_value">{{ $patient->tpa_validity ?? '-' }}</div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value empty" id="id_number_value">{{ $patient->identification_number ?? '-' }}</div>
                        </div>
                    </div>
                </div>
