...
class PatientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = Validator::make($request->all(), [
            ...
            'age.year'              => 'required|integer|min:0',
            'age.month'             => 'required|integer|min:0|max:11',
            'age.day'               => 'required|integer|min:0|max:31',
            'blood_group'           => 'nullable|in:1,2,3,4,5,6',
            ...
            'newspaper_preference'  => 'required|string|max:255',
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = Validator::make($request->all(), [
            ...
            'age.day'               => 'required|integer|min:0|max:31',
            'blood_group'           => 'nullable|in:1,2,3,4,5,6',
            'marital_status'        => 'required|in:Single,Married,Widowed,Separated,Not Specified',
            'file'                  => 'nullable|image|mimes:jpg,jpeg,png|max:2048',
            'phone'                 => 'nullable|string|max:20',
            'email'                 => 'nullable|email|max:255',
            'height'                => 'nullable|string|max:255',
            ...
            'languages_speak'       => 'required|string|max:255',
            'newspaper_preference'  => 'required|string|max:255',
            'address'               => 'required|string|max:500',
            'area'                  => 'required|string|max:255',
            'state_id'              => 'required|exists:states,id',
