                                                         ...
                                                         <?php $__currentLoopData = $purposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $purpose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    title="Delete"
                                                                    onclick="confirmDelete('delete-purpose-<?php echo e($purpose->id); ?>', 'Delete Purpose?', 'Are you sure you want to delete this purpose?')">
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\hims\resources\views/admin/setup/visitorspurpose.blade.php ENDPATH**/ ?>