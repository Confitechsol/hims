                                        ...
                                        <table class="table" id="birth">
                                            ...
                                            <tbody>
                                             ...
                                             <?php $__currentLoopData = $visitorsReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($report->visitors_purpose); ?></td>
                                                        <td><?php echo e($report->visitorBooks[0]->name ?? '-'); ?></td>
                                                        <td><?php echo e($report->visitorBooks[0]->visit_to ?? '-'); ?></td>
                                                        <td><?php echo e($report->visitorBooks[0]->related_to ?? '-'); ?></td>
                                                        <td><?php echo e($report->visitorBooks[0]->contact ?? '-'); ?></td>
                                                        <td>
                                                          <?php echo e(isset($report->visitorBooks[0]->date)
                                                         ? \Carbon\Carbon::parse($report->visitorBooks[0]->date)->format('Y-m-d')
                                                         : '-'); ?>

                                                        </td>
                                                        <td>
                                                          <?php echo e(isset($report->visitorBooks[0]->in_time)
                                                          ...
                                                          <td>
                                                          <?php echo e(isset($report->visitorBooks[0]->out_time)
