        ...
        <div class="col-md-11">
            <div class="card shadow-sm border-0 mt-4">
                <div class="card-header" style="background: linear-gradient(-90deg, #75009673 0%, #CB6CE673 100%)">
                    <h5 class="mb-0" style="color: #750096"><i class="fas fa-cogs me-2"></i>Leave Type List</h5>
                </div>
                                        ...
                                        <div class="page_btn d-flex">
                                            <div class="text-end d-flex">
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#add_leave_type"><i
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('leave-type.store')); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td>
                                                            <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($leave->type); ?>

                                                            </h6>
                                                        </td>
                                                        <td>
                                                            <form
                                                                action="<?php echo e(route('leave-type.updateStatus', [$leave->id])); ?>"
                                                                method="post">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="form-check form-switch mb-0">
                                                                    <input class="form-check-input status-toggle"
                                                                        ...
                                                                        <?php echo e($leave->is_active == 'yes' ? 'checked' : ''); ?>>
                                                                </div>
                                                            </form>
                                                        </td>
                                                        <td>
                                                            <a href="javascript: void(0);"
                                                                ...
                                                                data-id="<?php echo e($leave->id); ?>"
                                                                data-name="<?php echo e($leave->type); ?>">
                                                                <i class="ti ti-pencil"></i></a>
                                                            <form action="<?php echo e(route('leave-type.delete', [$leave->id])); ?>" class="d-inline"
                                                                id="delete-form-<?php echo e($leave->id); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                <?php echo method_field('DELETE'); ?>
                                                                <a href="javascript: void(0);"
                                                                    class="fs-18 p-1 btn btn-icon btn-sm btn-soft-danger rounded-pill delete-button"
                                                                    data-leave-type-id="<?php echo e($leave->id); ?>"
                                                                    data-leave-type-name="<?php echo e($leave->type); ?>"
                                                                    data-form-id="delete-form-<?php echo e($leave->id); ?>">
                                    ...
                                    <div class="modal fade" id="edit_leave_type" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('leave-type.update')); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\leave_type.blade.php ENDPATH**/ ?>