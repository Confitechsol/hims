...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.birth-modal','data' => ['type' => 'add','id' => 'createModal','title' => 'Add Death Record','action' => ''.e(route('death.create')).'','fields' => [
            [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'add','id' => 'createModal','title' => 'Add Death Record','action' => ''.e(route('death.create')).'','fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            [
                'name' => 'case_reference_id',
                'label' => 'Case ID',
                'type' => 'text',
...
patientIdField.addEventListener("input", function() {
    ...
    // Call API
    const baseUrl = "<?php echo e(route('death.patient', ['id' => 'ID'])); ?>";
