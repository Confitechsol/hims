                                ...
                                <div class="card-body">
                                    <div
                                        ...
                                        <div class="page_btn d-flex">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="add_item_category" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">Medical Equipment
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">Medical Consumables & Disposables
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">Surgical Instruments
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">General Supplies
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\hims\resources\views/admin/setup/item_category.blade.php ENDPATH**/ ?>