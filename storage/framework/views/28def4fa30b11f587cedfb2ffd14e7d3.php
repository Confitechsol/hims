            ...
            <div class="card shadow-sm border-0 mt-4">
                ...
                <div class="card-body">
                    <form id="settings_form" method="POST"
                        action="<?php echo e(isset($branch) && $branch->exists ? route('profile.update') : route('profile.store')); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="address"
                                value="<?php echo e($branch->address ?? '123 Main Street, City'); ?>">
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="phone"
                                    value="<?php echo e($branch->phone ?? '+91 9876543210'); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Email <span class="text-danger">*</span></label>
                                <input type="email" class="form-control" name="email"
                                    value="<?php echo e($branch->email ?? 'info@hospital.com'); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <?php if(isset($branch) && $branch->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $branch->image)); ?>" class="img-thumbnail me-2"
                                        style="height:40px;">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('uploads/hospital_content/logo/images.png')); ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if(isset($branch) && $branch->mini_logo): ?>
                                    <img src="<?php echo e(asset('storage/' . $branch->mini_logo)); ?>" class="img-thumbnail me-2"
                                        style="height:40px;">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('uploads/hospital_content/logo/images.png')); ?>"
                                        class="img-thumbnail me-2" style="height:40px;">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="language">
                                    <option value="English"
                                        <?php echo e(($branch->languages ?? 'English') == 'English' ? 'selected' : ''); ?>>English
                                    </option>
                                    <option value="Hindi"
                                        <?php echo e(($branch->languages ?? 'English') == 'Hindi' ? 'selected' : ''); ?>>Hindi</option>
                                    <option value="Bengali"
                                        <?php echo e(($branch->languages ?? 'English') == 'Bengali' ? 'selected' : ''); ?>>Bengali
                                    </option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="date_format">
                                    <option value="DD-MM-YYYY"
                                        <?php echo e(($branch->date_format ?? 'DD-MM-YYYY') == 'DD-MM-YYYY' ? 'selected' : ''); ?>>
                                        DD-MM-YYYY</option>
                                    <option value="MM-DD-YYYY"
                                        <?php echo e(($branch->date_format ?? 'DD-MM-YYYY') == 'MM-DD-YYYY' ? 'selected' : ''); ?>>
                                        MM-DD-YYYY</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="time_zone">
                                    <option value="Asia/Kolkata"
                                        <?php echo e(($branch->timezone ?? 'Asia/Kolkata') == 'Asia/Kolkata' ? 'selected' : ''); ?>>
                                        Asia/Kolkata</option>
                                    <option value="UTC"
                                        <?php echo e(($branch->timezone ?? 'Asia/Kolkata') == 'UTC' ? 'selected' : ''); ?>>UTC</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="time_format">
                                <option value="24-hour"
                                    <?php echo e(($branch->time_format ?? '24-hour') == '24-hour' ? 'selected' : ''); ?>>24-hour
                                </option>
                                <option value="12-hour"
                                    <?php echo e(($branch->time_format ?? '24-hour') == '12-hour' ? 'selected' : ''); ?>>12-hour
                                </option>
                            </select>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-3">
                                <label class="form-label">Currency<small class="req"> *</small></label>
                            ...
                            <!-- Currency Symbol -->
                            <div class="col-md-4">
                                <label class="form-label">Currency Symbol<small class="req"> *</small></label>
                                <input id="currency_symbol" name="currency_symbol" type="text" class="form-control"
                                    value="INR">
                                <span class="text-danger"></span>
                            </div>
                            <!-- Credit Limit -->
                            <div class="col-sm-4">
                                <label class="form-label">Credit Limit<small class="req"> *</small></label>
                                                                                                                                ...
                                                                                                                                <div class="row">
                                                                                                                                    <div class="col-sm-3 text-center">
                                                                                                                                        ...
                                                                                                                                        <label for="theme_default">
                                                                                                                                            <img src="<?php echo e(asset('backend/images/default.jpg')); ?>"
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-3 text-center">
                                                                                                                                        ...
                                                                                                                                        <label for="theme_red">
                                                                                                                                            <img src="<?php echo e(asset('backend/images/red.jpg')); ?>" class="img-fluid border rounded">
                                                                                                                                        </label>
                                                                                                                                    </div>
                                                                                                                                    <div class="col-sm-3 text-center">
                                                                                                                                        <input type="radio" name="theme" id="theme_blue">
                                                                                                                                        <label for="theme_blue">
                                                                                                                                            <img src="<?php echo e(asset('backend/images/blue.jpg')); ?>" class="img-fluid border rounded">
                                                                                                                                        </label>
                                                                                                                                    </div>
                                                                                                                                    <div class="col-sm-3 text-center">
                                                                                                                                        <input type="radio" name="theme" id="theme_gray">
                                                                                                                                        <label for="theme_gray">
                                                                                                                                            <img src="<?php echo e(asset('backend/images/gray.jpg')); ?>" class="img-fluid border rounded">
                                                                                                                                        </label>
                                                                                                                                    </div>
                                                                                                                                </div> -->
                        ...
                        <div class="row text-end">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary fw-bold" onclick="addBranchFields()">
                                    Add Branch
                                </button>
                            </div>
                        </div>
                        <div id="branchesContainer" style="margin-top: 15px;"></div>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\hims\resources\views/admin/setup/profile.blade.php ENDPATH**/ ?>