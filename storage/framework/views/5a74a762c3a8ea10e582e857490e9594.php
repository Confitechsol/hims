                    ...
                    <div class="p-2 select2-full-width">
                        <select class="form-control select2" id="duty_roster_doctor" name="doctor_id" required>
                            ...
                            <?php $__currentLoopData = $doctorList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($doctor->id); ?>"><?php echo e($doctor->name); ?> (<?php echo e($doctor->doctor_code ?? ''); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                                        ...
                                        <?php $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li class="col-sm-4">
                                                <label>
                                                    ...
                                                    <div class="stepimage">
                                                        <?php echo e($shift->shift_name); ?><br>
                                                        <?php echo e(Carbon\Carbon::parse($shift->shift_start)->format('h:i A')); ?> - <?php echo e(Carbon\Carbon::parse($shift->shift_end)->format('h:i A')); ?>
