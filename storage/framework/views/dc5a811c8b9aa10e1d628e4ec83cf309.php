                                        ...
                                        <div class="card-body">
                                            <form action="">
                                                <div class="row gy-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="id_title" class="form-label">ID Card Title <span
                                                                class="text-danger">*</span></label>
                                                                ...
                                                                <div class="d-flex align-items-center flex-wrap gap-2">
                                                                    <div class="text-end d-flex">
                                                                        <a href="patient_details_template"
                                                                            ...
                                                                            data-bs-target="#patient_id_card">Sample Staff
                                                                            ID Card</a>
                                                                    </div>
                                                                    <!-- First Modal -->
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="fw-bold modal-title">Staff
                                                                                        ID Card</h5>
                                                                                    <button type="button"
                                                                                    ...
                                                                                    <div class="card bg-light">
                                                                                        <div class="card-body">
                                                                                            <div
                                                                                                ...
                                                                                                <div>
                                                                                                    <span
                                                                                                        class="text-primary mb-1">9000</span>
                                                                                                    <div
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\hims\resources\views/admin/certificate/staff_id.blade.php ENDPATH**/ ?>