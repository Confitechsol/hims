        ...
        <div class="col-md-11">
            <div class="card shadow-sm border-0 mt-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('pharmacy.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="medicine_name" class="form-control" 
                                       value="<?php echo e(old('medicine_name')); ?>" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="medicine_category_id" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>" <?php echo e(old('medicine_category_id') == $category->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="medicine_company" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($company->id); ?>" <?php echo e(old('medicine_company') == $company->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="medicine_composition" class="form-control" 
                                       value="<?php echo e(old('medicine_composition')); ?>">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="medicine_group" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($group->id); ?>" <?php echo e(old('medicine_group') == $group->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="reorder_level" class="form-control" 
                                       value="<?php echo e(old('reorder_level')); ?>">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="gst_percentage" class="form-select">
                                    ...
                                    <option value="0" <?php echo e(old('gst_percentage') == '0' ? 'selected' : ''); ?>>0% (Exempt)</option>
                                    <option value="5" <?php echo e(old('gst_percentage') == '5' ? 'selected' : ''); ?>>5%</option>
                                    <option value="12" <?php echo e(old('gst_percentage') == '12' ? 'selected' : ''); ?>>12%</option>
                                    <option value="18" <?php echo e(old('gst_percentage') == '18' ? 'selected' : ''); ?>>18%</option>
                                    <option value="28" <?php echo e(old('gst_percentage') == '28' ? 'selected' : ''); ?>>28%</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="unit_packing" class="form-control" 
                                       value="<?php echo e(old('unit_packing')); ?>" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="rack_number" class="form-control" 
                                       value="<?php echo e(old('rack_number')); ?>">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="is_active" class="form-select">
                                    <option value="yes" <?php echo e(old('is_active', 'yes') == 'yes' ? 'selected' : ''); ?>>Active</option>
                                    <option value="no" <?php echo e(old('is_active') == 'no' ? 'selected' : ''); ?>>Inactive</option>
                                </select>
                            </div>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\pharmacy\create.blade.php ENDPATH**/ ?>