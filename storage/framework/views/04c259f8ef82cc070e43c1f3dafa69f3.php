                        ...
                        <div class="patient-info-card">
                                ...
                                <div class="header-content">
                                    <div class="patient-avatar-wrapper">
                                        <div class="patient-avatar">
                                            <img src="<?php echo e(asset('assets/img/patient.png')); ?>"
                                                alt="Patient Photo">
                                        </div>
                                ...
                                <div class="info-grid">
                                    <div class="info-item">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="info-value"><?php echo e($opd->patient->mobileno ?? '--'); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="info-value"><?php echo e($opd->patient->age); ?> Year
                                                <?php echo e($opd->patient->month); ?>
                                                Month<?php echo e($opd->patient->day); ?> Days (As
                                                Of
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="info-value empty">
                                                <?php echo e($opd->patient->guardian_name ?? '--'); ?>
                                ...
                                <div class="info-grid">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="info-value empty">
                                                <?php echo e($opd->patient->tpa_validity ?? '--'); ?>
                            ...
                            <div class="d-flex align-items-center mb-3 px-3">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <p class=" mb-0">
                                    <ul class="m-0">
                                        <?php $__currentLoopData = $symptoms;
                                                    $__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $symptom): $__env->incrementLoopIndices();
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="progress mb-3 mt-1" role="progressbar" aria-valuenow="68.18"
                                        ...
                                        <div class="progress-bar bg-gradient"
                                            style="width:                                                              <?php echo e(($opd->paid_amount / $opd->amount) * 100); ?>%;">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table-nowrap">
                                <table class="table border">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $medicationReport;
                                                $__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $medication): $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                        <tr>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table-nowrap">
                                <table class="table border">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $labInvestigations;
                                                $__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $lab): $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table-nowrap">
                                <table class="table border">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $operationDetail;
                                                $__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $operation): $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                        <tr>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table-nowrap">
                                <table class="table border">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $opdCharges;
                                                $__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $charge): $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                        <?php
                                                            $taxAmount =
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><?php echo e($charge->charge->standard_charge); ?>
                                            </td>
                                            <td class="text-right">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php $__currentLoopData = $opdSymptoms[$visit->opd->opd_no];
                                                                                        $__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $symptom): $__env->incrementLoopIndices();
                                                                                        $loop = $__env->getLastLoop(); ?>
                                                                <span
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    ...
                                                                    <a href="javascript: void(0);"
                                                                        ...
                                                                        data-is-ipd="false"
                                                                        data-id="<?php echo e($visit->opd->id); ?>"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                                            <div class="modal-content ">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="<?php echo e(route('opd.createMedication')); ?>"
                                                                        method="post">
                                                                        <?php echo csrf_field(); ?>
                                                                        <div class="row gy-3">
                                                ...
                                                <table class="table border">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($medication->pharmacy->medicine_name); ?>
                                                            </td>
                                                            <td> Time:
                                                    ...
                                                    <div class="modal fade" id="add_charges" tabindex="-1"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="<?php echo e(route('opd.addOpdCharge')); ?>"
                                                    ...
                                                    <div class="modal fade" id="add_timeline" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="<?php echo e(route('patient-timeline.store')); ?>"
                                                                    method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                        ...
                                                                        <div class="row gy-3">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <input type="hidden" name="patient_id"
                                                                                    value="<?php echo e($opd->patient->id); ?>">
