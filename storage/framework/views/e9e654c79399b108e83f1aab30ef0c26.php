                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('operation-category.store')); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                 <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td>
                                                            <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($category->category); ?></h6>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);"
                                                                ...
                                                                data-category-name="<?php echo e($category->category); ?>">
                                                                <i class="ti ti-pencil"></i>
                                                            </a>
                                                            <a href="javascript:void(0);"
                                                                onclick="deleteOperationCategory(<?php echo e($category->id); ?>)"
...
function openOperationCategoryModal(el) {
    ...
    form.action = "<?php echo e(url('operation-category/update')); ?>/" + id; // route to update
...
<script>
    function deleteOperationCategory(id) {
        if (confirm("Are you sure you want to delete this operation?")) {
            ...
            form.action = "<?php echo e(url('operation-category/destroy')); ?>/" + id; // adjust route if needed
            form.submit();
        }
    }
</script>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\operation_category.blade.php ENDPATH**/ ?>