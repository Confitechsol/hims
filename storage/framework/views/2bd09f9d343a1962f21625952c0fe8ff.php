                                            ...
                                            <div class="form-row cols-2">
                                                <div class="field-group">
                                                    ...
                                                    <input type="date" name="appointment_date" id="appointment_date"
                                                        class="form-control"
                                                        value="<?php echo e(old('appointment_date', $ipd->date)); ?>" required disabled>
                                                </div>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp-8.2\htdocs\hims\resources\views/admin/ipd/edit-ipd.blade.php ENDPATH**/ ?>