...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.birth-modal','data' => ['type' => 'add','id' => 'createModal','class' => 'modal-fullscreen','title' => 'Add Birth Record','action' => ''.e(route('tpamanagement.store')).'','fields' => [
            [
                'name' => 'child_name',
                'label' => 'Child Name',
                'type' => 'text',
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'add','id' => 'createModal','class' => 'modal-fullscreen','title' => 'Add Birth Record','action' => ''.e(route('tpamanagement.store')).'','fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            [
                'name' => 'child_name',
                'label' => 'Child Name',
                'type' => 'text',
