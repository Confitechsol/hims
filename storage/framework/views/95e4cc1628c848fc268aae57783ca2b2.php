        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered datatable">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $durations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $duration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($duration->name); ?></td>
                            <td>
                                <button class="btn btn-sm btn-info" onclick="editDuration(<?php echo e($duration->id); ?>, '<?php echo e($duration->name); ?>')">
                                    <i class="ti ti-pencil"></i>
                                </button>
                                <form action="<?php echo e(route('setup.dose-duration.destroy', $duration->id)); ?>" method="POST" style="display:inline" onsubmit="return confirm('Are you sure?')">
                                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addDurationModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('setup.dose-duration.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
function editDuration(id, duration) {
    ...
    document.getElementById('editDurationForm').action = "<?php echo e(url('setup/dose-duration/update')); ?>/" + id;
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\dose_duration.blade.php ENDPATH**/ ?>