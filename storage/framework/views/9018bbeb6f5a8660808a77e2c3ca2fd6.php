<?php $__env->startSection('content'); ?>
        ...
        <div class="col-md-11">
            <div class="card shadow-sm border-0 mt-4">
                <div class="card-header" style="background: linear-gradient(-90deg, #75009673 0%, #CB6CE673 100%)">
                    <h5 class="mb-0" style="color: #750096"><i class="fas fa-cogs me-2"></i>Designation List</h5>
                </div>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form
                                                                action="<?php echo e(route('designation.updateStatus', [$designation->id])); ?>"
                                                                method="post">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="form-check form-switch mb-0">
                                                                    <input class="form-check-input status-toggle"
                                                                        ...
                                                                        <?php echo e($designation->is_active == 'yes' ? 'checked' : ''); ?>>
                                                                </div>
                                                            </form>
                                                        </td>
                                                        <td>
                                                            <a href="javascript: void(0);"
                                                                ...
                                                                data-id="<?php echo e($designation->id); ?>"
                                                                data-name="<?php echo e($designation->designation); ?>">
                                                                <i class="ti ti-pencil"></i></a>
                                                            <form
                                                                action="<?php echo e(route('designation.delete', [$designation->id])); ?>"
                                                                class="d-inline" id="delete-form-<?php echo e($designation->id); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                <?php echo method_field('DELETE'); ?>
                                                                <a href="javascript: void(0);"
                                                                    class="fs-18 p-1 btn btn-icon btn-sm btn-soft-danger rounded-pill delete-button"
                                                                    data-designation-id="<?php echo e($designation->id); ?>"
                                                                    data-designation-name="<?php echo e($designation->designation); ?>"
                                                                    data-form-id="delete-form-<?php echo e($designation->id); ?>">
                                    ...
                                    <div class="modal fade" id="edit_designation" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('designation.update')); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var editModal = document.getElementById('edit_designation');
    ...
    <script>
        document.querySelectorAll('.delete-button').forEach(input => {
            input.addEventListener('click', function() {
                const designationId = this.dataset.designationId;
                const designationName = this.dataset.designationName;
                const formId = this.dataset.formId;

                Swal.fire({
                    title: `Please Confirm`,
                    text: `Delete Designation ${designationName}(${designationId})`,
                    icon: 'warning',
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/setup/designation.blade.php ENDPATH**/ ?>