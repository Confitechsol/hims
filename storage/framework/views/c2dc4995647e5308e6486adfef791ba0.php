        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('ipd.prescription.update', $prescription->id)); ?>" method="POST" enctype="multipart/form-data" id="editPrescriptionForm">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        
                        <input type="hidden" name="ipd_id" value="<?php echo e($prescription->ipd_id); ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control select2" name="prescribe_by" id="prescribe_by" required>
                                    ...
                                    <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($doctor->id); ?>" <?php echo e($prescription->prescribed_by && (int)$prescription->prescribed_by === (int)$doctor->id ? 'selected' : ''); ?>>
                                            <?php echo e($doctor->name); ?> (<?php echo e($doctor->doctor_id ?? 'N/A'); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" value="<?php echo e($prescription->date->format('Y-m-d')); ?>" disabled>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Header Note</label>
                            <textarea name="header_note" class="form-control" rows="4"><?php echo e($prescription->header_note); ?></textarea>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <select class="form-control multiselect2" name="finding_type[]" multiple>
                                    ...
                                    ?>
                                    <option value="1" <?php echo e(in_array('1', $selectedCategories) ? 'selected' : ''); ?>>General Examination</option>
                                    <option value="2" <?php echo e(in_array('2', $selectedCategories) ? 'selected' : ''); ?>>Vitals</option>
                                    <option value="3" <?php echo e(in_array('3', $selectedCategories) ? 'selected' : ''); ?>>Cardiovascular System</option>
                                    <option value="4" <?php echo e(in_array('4', $selectedCategories) ? 'selected' : ''); ?>>Gynecological</option>
                                    <option value="5" <?php echo e(in_array('5', $selectedCategories) ? 'selected' : ''); ?>>ENT / Oral Cavity</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                ...
                                <select class="form-control multiselect2" name="findings[]" multiple>
                                    ...
                                    ?>
                                    <option value="1" <?php echo e(in_array('1', $selectedFindings) ? 'selected' : ''); ?>>General Examination</option>
                                    <option value="2" <?php echo e(in_array('2', $selectedFindings) ? 'selected' : ''); ?>>Vitals</option>
                                    <option value="3" <?php echo e(in_array('3', $selectedFindings) ? 'selected' : ''); ?>>Cardiovascular System</option>
                                    <option value="4" <?php echo e(in_array('4', $selectedFindings) ? 'selected' : ''); ?>>Gynecological</option>
                                    <option value="5" <?php echo e(in_array('5', $selectedFindings) ? 'selected' : ''); ?>>ENT / Oral Cavity</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Finding Description</label>
                                <textarea name="finding_description" class="form-control" rows="3"><?php echo e($prescription->finding_description); ?></textarea>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Finding Print</label><br>
                                <input type="checkbox" name="finding_print" value="yes" <?php echo e($prescription->is_finding_print == 'yes' ? 'checked' : ''); ?>>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control pathology-test-select" name="pathology[]" id="pathologyOpt" multiple style="width: 100%;">
                                    <?php $__currentLoopData = $pathologies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pathology): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($pathology->id); ?>" <?php echo e(in_array($pathology->id, $selectedPathologyIds) ? 'selected' : ''); ?>>
                                            <?php echo e($pathology->test_name ?? $pathology->name); ?> (<?php echo e($pathology->short_name ?? ''); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="form-control radiology-test-select" name="radiology[]" id="radiologyOpt" multiple style="width: 100%;">
                                    <?php $__currentLoopData = $radiologies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $radiology): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($radiology->id); ?>" <?php echo e(in_array($radiology->id, $selectedRadiologyIds) ? 'selected' : ''); ?>>
                                            <?php echo e($radiology->test_name ?? $radiology->name); ?> (<?php echo e($radiology->short_name ?? ''); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="medicineContainer">
                                <?php if($prescription->medicines && $prescription->medicines->count() > 0): ?>
                                    <?php $__currentLoopData = $prescription->medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="medicine-row row mt-3" data-row="<?php echo e($index + 1); ?>" id="row<?php echo e($index + 1); ?>">
                                            ...
                                            <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                                <div>
                                                    ...
                                                    <select class="form-control select2 medicine_name" data-rowid="<?php echo e($index + 1); ?>" style="width:100%" name="medicines[]" data-medicine-id="<?php echo e($medicine->pharmacy_id); ?>">
                                                        <option value="">Select</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                                <div>
                                                    ...
                                                    <select class="form-control select2 medicine_dosage" style="width:100%" name="dosages[]" data-dosage-id="<?php echo e($medicine->medicine_dosage_id); ?>">
                                                        <option value="">Select</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                                <div>
                                                    ...
                                                    <select class="form-control select2 interval_dosage" id="interval_dosage_<?php echo e($index + 1); ?>" name="interval_dosages[]" style="width:100%" data-interval-id="<?php echo e($medicine->dose_interval_id); ?>">
                                                        <option value="">Select</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                                <div>
                                                    ...
                                                    <select class="form-control select2 duration_dosage" id="duration_dosage_<?php echo e($index + 1); ?>" name="duration_dosages[]" style="width:100%" data-duration-id="<?php echo e($medicine->dose_duration_id); ?>">
                                                        <option value="">Select</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                <div>
                                                    ...
                                                    <textarea name="instructions[]" style="height:28px;" class="form-control"><?php echo e($medicine->instruction); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 d-flex align-items-center">
                                                <div>
                                                    <button type="button" class="btn btn-sm btn-danger delete_row" data-row-id="<?php echo e($index + 1); ?>" autocomplete="off"><i class="fa fa-remove"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="footer_note" class="form-control" rows="4"><?php echo e($prescription->footer_note); ?></textarea>
                        </div>
                            ...
                            <?php if($prescription->attachment): ?>
                                <div class="mb-2">
                                    <a href="<?php echo e(asset('storage/' . $prescription->attachment)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                                        <i class="ti ti-download"></i> Current: <?php echo e($prescription->attachment_name); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label><input type="checkbox" name="visible[]" value="1" <?php echo e(in_array('1', $selectedNotifications) ? 'checked' : ''); ?>> Admin</label>
                                </div>
                                <div class="col-md-3">
                                    <label><input type="checkbox" name="visible[]" value="2" <?php echo e(in_array('2', $selectedNotifications) ? 'checked' : ''); ?>> Accountant</label>
                                </div>
                                <div class="col-md-3">
                                    <label><input type="checkbox" name="visible[]" value="3" <?php echo e(in_array('3', $selectedNotifications) ? 'checked' : ''); ?>> Doctor</label>
                                </div>
                                <div class="col-md-3">
                                    <label><input type="checkbox" name="visible[]" value="4" <?php echo e(in_array('4', $selectedNotifications) ? 'checked' : ''); ?>> Pharmacist</label>
                                </div>
                            </div>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('ipd.show', $prescription->ipd_id)); ?>" class="btn btn-secondary">Cancel</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.jQuery && $.fn.select2) {
        ...
        const selectedDoctorId = <?php echo e($prescription->prescribed_by ?? 'null'); ?>;
    ...
    const existingMedicines = <?php echo json_encode($prescription->medicines ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp-8.2\htdocs\hims\resources\views/admin/ipd/prescription/edit.blade.php ENDPATH**/ ?>