                ...
                <table class="table table-bordered datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-info" onclick="editCompany(<?php echo e($company->id); ?>, '<?php echo e($company->company_name); ?>')">
                                    <i class="ti ti-pencil"></i>
                                </button>
                                <form action="<?php echo e(route('setup.medicine-company.destroy', $company->id)); ?>" method="POST" style="display:inline" onsubmit="return confirm('Are you sure?')">
                                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addCompanyModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('setup.medicine-company.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
function editCompany(id, name) {
    ...
    document.getElementById('editCompanyForm').action = "<?php echo e(url('setup/medicine-company/update')); ?>/" + id;
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\medicine_company.blade.php ENDPATH**/ ?>