    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            if (!button) return;
                    ...
                    // form.action = `<?php echo e(url('/')); ?>/medicine-group/${id}`;
                    ...
                    inputFields.forEach(input => {
                        ...
                        if (isImage) {
                         ...
                         input.src = "<?php echo e(url('/')); ?>"+fieldValue;
                         } else {
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hims\resources\views/components/modals/form-modal.blade.php ENDPATH**/ ?><?php $attributes ??= new \Illuminate\View\ComponentAttributeBag;
