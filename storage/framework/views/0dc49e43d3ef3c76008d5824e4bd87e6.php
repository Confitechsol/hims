    ...
    <div class="container">
        <div class="card shadow-sm border-0 mt-4">
            <div class="card-header d-flex justify-content-between align-items-center align-items-sm-center justify-content-between flex-sm-row"
                ...
                <h5 class="mb-0" style="color: #750096"><i class="fas fa-cogs me-2"></i>Edit OPD Details</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="editOpdForm" action="<?php echo e(route('opd.update', [$opd->id])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                            ...
                                            <div class="form-row cols-3">
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <input type="text" name="symptoms_description"
                                                        ...
                                                        value="<?php echo e(old('symptoms_description', $opd->symptoms_description)); ?>"
                                            ...
                                            <div class="form-row cols-2">
                                                <div class="field-group">
                                                    ...
                                                    <input type="date" name="appointment_date" id="appointment_date"
                                                        class="form-control"
                                                        value="<?php echo e(old('appointment_date', $opd->appointment_date)); ?>"
                                                        required>
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <select name="old_patient" id="old_patient" class="form-select">
                                                        ...
                                                        <option value="Old Patient"
                                                            <?php echo e(old('old_patient', $opd->case_type ?? '') == 'Old Patient' ? 'selected' : ''); ?>>
                                                            Old Patient</option>
                                                        <option value="New Patient"
                                                            <?php echo e(old('old_patient', $opd->case_type ?? '') == 'New Patient' ? 'selected' : ''); ?>>
                                                            New Patient</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <select name="casualty" id="casualty" class="form-select">
                                                        <option value="">Select</option>
                                                        <option value="No"
                                                            <?php echo e(old('casualty', $opd->casualty ?? '') == 'No' ? 'selected' : ''); ?>>
                                                            No</option>
                                                        <option value="Yes"
                                                            <?php echo e(old('casualty', $opd->casualty ?? '') == 'Yes' ? 'selected' : ''); ?>>
                                                            Yes</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <input type="text" name="reference" id="reference"
                                                        class="form-control"
                                                        value="<?php echo e(old('reference', $opd->reference)); ?>"
                                                    ...
                                                    <select name="consultant_doctor" id="consultant_doctor"
                                                        ...
                                                        <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($doctor->id); ?>"
                                                                <?php echo e(old('consultant_doctor', $opd->doctor_id ?? '') == $doctor->id ? 'selected' : ''); ?>>
                                            ...
                                            <div class="form-row cols-2">
                                                <div class="field-group">
                                                    ...
                                                    <input type="date" name="payment_date" id="payment_date"
                                                        class="form-control"
                                                        value="<?php echo e(old('payment_date', $opd->payment_date)); ?>" required>
                                                </div>
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <div class="amount-input-group">
                                                        ...
                                                        <input type="number" name="paid_amount" id="paid_amount"
                                                            class="form-control"
                                                            value="<?php echo e(old('paid_amount', $opd->paid_amount)); ?>"
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <select name="payment_mode" id="payment_mode" class="form-select">
                                                        ...
                                                        <option value="Cash"
                                                            <?php echo e(old('payment_mode', $opd->payment_mode ?? '') == 'Cash' ? 'selected' : ''); ?>>
                                                            Cash</option>
                                                        <option value="Card"
                                                            <?php echo e(old('payment_mode', $opd->payment_mode ?? '') == 'Card' ? 'selected' : ''); ?>>
                                                            Card</option>
                                                        <option value="UPI"
                                                            <?php echo e(old('payment_mode', $opd->payment_mode ?? '') == 'UPI' ? 'selected' : ''); ?>>
                                                            UPI</option>
                                                        <option value="Net Banking"
                                                            <?php echo e(old('payment_mode', $opd->payment_mode ?? '') == 'Net Banking' ? 'selected' : ''); ?>>
                                                            Net Banking</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="section-body">
                                            <div class="form-row cols-2">
                                                <div class="field-group">
                                                    ...
                                                    <textarea name="note" id="note" class="form-control" placeholder="Enter notes" rows="4"><?php echo e(old('note', $opd->note)); ?></textarea>
                                                </div>

                                                <div class="field-group">
                                                    <label for="known_allergies" class="form-label">Any Known
                                                        Allergies</label>
                                                    <textarea name="known_allergies" id="known_allergies" class="form-control" placeholder="Enter known allergies"
                                                        rows="4"><?php echo e(old('known_allergies', $opd->allergies)); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        ...
                                        <button type="submit" form="editOpdForm" class="btn btn-primary">
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/opd/edit-opd.blade.php ENDPATH**/ ?>