            ...
            <div class="card shadow-sm border-0 mt-4">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <a href="<?php echo e(route('radiology.billing.create')); ?>" class="btn btn-primary text-white">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>RADB<?php echo e(str_pad($bill->id, 2, '0', STR_PAD_LEFT)); ?></td>
                                        ...
                                        <td>
                                            <?php if($bill->organisation_id && $bill->organisation): ?>
                                                <span class="badge bg-info"><?php echo e($bill->organisation->organisation_name); ?></span>
                                                <?php if($bill->organisation->code): ?>
                                                    <small class="text-muted">(<?php echo e($bill->organisation->code); ?>)</small>
                                                <?php endif; ?>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="<?php echo e(route('radiology.billing.show', $bill->id)); ?>" class="btn btn-sm btn-info text-white" title="View">
                                                    <i class="ti ti-eye"></i>
                                                </a>
                                                <a href="<?php echo e(route('radiology.billing.edit', $bill->id)); ?>" class="btn btn-sm btn-warning text-white" title="Edit">
                                                    <i class="ti ti-edit"></i>
                                                </a>
                                                <form action="<?php echo e(route('radiology.billing.destroy', $bill->id)); ?>" method="POST" class="d-inline" onsubmit="return confirmDeleteForm(event, 'Delete Billing?', 'Are you sure you want to delete this billing record?');">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp-8.2\htdocs\hims\resources\views/admin/radiology/billing/index.blade.php ENDPATH**/ ?>