                    ...
                    <form action="">
                        <div class="row align-items-center gy-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="patient_status" id="patient_status" class="form-select">
                                    <option value="" selected disabled>Select</option>
                                    <option value="on_bed">On Bed</option>
                                </select>
                            </div>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\hims\resources\views/admin/reports/ipd/ipd_balance_reports.blade.php ENDPATH**/ ?>