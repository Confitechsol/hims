...
<div class="modal fade" id="addPrescriptionModal" tabindex="-1" aria-labelledby="addPrescriptionModalLabel"
    ...
    <div class="modal-dialog modal-fullscreen ">
        ...
        <div class="modal-content" style="overflow: visible;">
            ...
            <form action="<?php echo e(route('ipd.addPrescription')); ?>" id="prescriptionForm" method="post" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                    ...
                    <div class="row p-4 mx-1">
                        <div class="col-sm-9">
                            <div class="ptt10">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input type="hidden" id="opd_id" name="opd_id" value="<?php echo e(isset($opd) ? $opd->id : ''); ?>">
                                        <input type="hidden" id="ipd_id" name="ipd_id" value="<?php echo e(isset($ipd) ? $ipd->id : ''); ?>">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control pathology-test-select" name="pathology[]" id="pathologyOpt" multiple style="width: 100%;">
                                            ...
                                            <?php if(isset($pathologies) && count($pathologies) > 0): ?>
                                                <?php $__currentLoopData = $pathologies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pathology): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($pathology->id); ?>">
                                                        <?php echo e($pathology->test_name); ?><?php echo e($pathology->short_name ? ' (' . $pathology->short_name . ')' : ''); ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control radiology-test-select" name="radiology[]" id="radiologyOpt" multiple style="width: 100%;">
                                            <option value="">Select Tests</option>
                                            <?php if(isset($radiologies) && count($radiologies) > 0): ?>
                                                <?php $__currentLoopData = $radiologies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $radiology): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($radiology->id); ?>">
                                                        <?php echo e($radiology->test_name); ?><?php echo e($radiology->short_name ? ' (' . $radiology->short_name . ')' : ''); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%" name="prescribe_by" id="prescribe_by" required>
                                            ...
                                            <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($doctor->id); ?>"><?php echo e($doctor->name); ?> (<?php echo e($doctor->doctor_id ?? 'N/A'); ?>)</option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (prescriptionForm) {
            ...
            window.loadAllMedicines = function(selectElement) {
                ...
                const allMedicinesUrl = "<?php echo e(route('pharmacy.api.medicines')); ?>";
            ...
            Promise.all([
                fetch("<?php echo e(route('getMedicineCategories')); ?>").then(res => {
                    if (!res.ok) throw new Error('Failed to fetch categories');
                    return res.json();
                }),
                fetch("<?php echo e(route('getDoseIntervals')); ?>").then(res => {
                    if (!res.ok) throw new Error('Failed to fetch intervals');
                    return res.json();
                }),
                fetch("<?php echo e(route('getDoseDurations')); ?>").then(res => {
        ...
        window.loadMedicinesOnModalOpen = function() {
            ...
            medicineRows.forEach((row, index) => {
                ...
                if (medicineSelect) {
                    ...
                    const apiUrl = "<?php echo e(route('pharmacy.api.medicines')); ?>";
        ...
        function initializePathologyMultiselect() {
            ...
            if (!hasOptions) {
                ...
                const pathologyUrl = "<?php echo e(route('getPathologies')); ?>";
                fetch(pathologyUrl, {
                    method: 'GET',
                    headers: {
        ...
        function initializeRadiologyMultiselect() {
            ...
            if (!hasOptions) {
                ...
                const radiologyUrl = "<?php echo e(route('getRadiologies')); ?>";
                fetch(radiologyUrl, {
                    method: 'GET',
                    headers: {
                        'Accept': 'application/json',
...
<?php /**PATH D:\xampp-8.2\htdocs\hims\resources\views/components/modals/add-prescription-modal.blade.php ENDPATH**/ ?>