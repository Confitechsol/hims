...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-actions.actions','data' => ['id' => 'unit','name' => 'Unit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'unit','name' => 'Unit']); ?>
...
<?php endif; ?> 
                                    ...
                                    <table class="table mb-0" id="unit">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($item->id); ?>
                                                    ...
                                                    <button
                                                            ...
                                                            data-unit_name="<?php echo e($item->unit_name); ?>">
                                                            <i class="ti ti-pencil"></i></button>
                                                            <form action="<?php echo e(route('unit-list.destroy')); ?>"
                                ...
                                <div class="mt-3" id="pagination-wrapper">
                                    ...
                                    <?php if($units->onFirstPage()): ?>
                                        <button class="btn btn-outline-secondary btn-sm me-1" disabled>« Prev</button>
                                    <?php else: ?>
                                        <a href="<?php echo e($units->previousPageUrl()); ?><?php echo e(request('perPage') ? '&perPage=' . request('perPage') : ''); ?>"
                                    ...
                                    <?php for($page = 1; $page <= $lastPage; $page++): ?>
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e($units->url($page)); ?><?php echo e(request('perPage') ? '&perPage=' . request('perPage') : ''); ?>"
                                                class="btn btn-outline-secondary btn-sm me-1">
                                                <?php echo e($page); ?>
                                    ...
                                    <?php if($units->hasMorePages()): ?>
                                        <a href="<?php echo e($units->nextPageUrl()); ?><?php echo e(request('perPage') ? '&perPage=' . request('perPage') : ''); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.form-modal','data' => ['type' => 'add','id' => 'createModal','title' => 'Add Unit','action' => ''.e(route('unit-list.store')).'','repeatableGroup' => [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'add','id' => 'createModal','title' => 'Add Unit','action' => ''.e(route('unit-list.store')).'','repeatable_group' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['name' => 'unit_name', 'label' => 'Unit Name', 'type' => 'text', 'required' => true,'size'=>'11']
        ]),'columns' => 2]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (isset($component)) { $__componentOriginal66ca70ec79ff22faa62f501a1b49a88a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66ca70ec79ff22faa62f501a1b49a88a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.form-modal','data' => ['method' => 'put','type' => 'edit','id' => 'edit_modal','title' => 'Edit Unit','action' => ''.e(route('unit-list.update')).'','fields' => [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['method' => 'put','type' => 'edit','id' => 'edit_modal','title' => 'Edit Unit','action' => ''.e(route('unit-list.update')).'','fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['name' => 'id', 'type' => 'hidden', 'required' => true],
        ['name' => 'unit_name', 'label' => 'Unit Name', 'type' => 'text', 'required' => true, 'size' => '12']
    ]),'columns' => 2]); ?>
<?php echo $__env->renderComponent(); ?>
...
document.addEventListener('DOMContentLoaded', function () {    
    createAjaxTable({
    apiUrl: "<?php echo e(route('unit-list')); ?>",
    tableSelector: "#unit",
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\unit_list.blade.php ENDPATH**/ ?>