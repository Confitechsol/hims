                            ...
                            <div class="col-md-4">
                                ...
                                <select id="doctor" name="doctor" class="select2 form-select" style="width: 100%">
                                    ...
                                    <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($doctor->id); ?>"><?php echo e($doctor->name); ?> (<?php echo e($doctor->doctor_id); ?>)</option>
...
<script>
    $(document).ready(function () {
        ...
        $('#charge_category').on('change', function () {
            ...
            if (categoryId) {
                $.ajax({
                    url: "<?php echo e(url('slots/get-charges')); ?>/" + categoryId,
                    type: "GET",
...
<script>
    function searOle() {
        ...
        $.ajax({
            url: '<?php echo e(route("slots.search")); ?>',
            type: 'GET',
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/setup/slots.blade.php ENDPATH**/ ?>