                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between border-1 border-bottom pb-3 mb-3">
                            <div class="hospital_logo">
                                <img src=<?php echo e(asset('assets/images/logo.webp')); ?> class="logo-white"
                                    alt="logo">
                            </div>
                        ...
                        <div
                            ...
                            <div class="text-lg-end">
                                ...
                                <p class="text-dark mb-1"> Prescribed on : <span class="text-body" id="ipd_date"></span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="px-3 py-2 bg-light rounded d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <p class="mb-0 text-dark"> Patient ID: <span class="text-body" id="p_id"></span></p>
                                </div>
                            </div>
                        </div>
        ...
        if (isIpd === "true") {
            ...
            fetch(finalUrl)
                ...
                .then(data => {
                    ...
                    const baseUrlMed =
                        "<?php echo e(route('getIpdMedicineById', ['id' => 'ID'])); ?>";
            ...
            fetch(finalUrl)
                ...
                .then(data => {
                    ...
                    const baseUrlMed =
                        "<?php echo e(route('getOpdMedicineById', ['id' => 'ID'])); ?>";
                    const finalUrlMed = baseUrlMed.replace('ID', pres_id);
                    fetch(finalUrlMed).then(response => response.json())
                        .then(data => {
                            window.nursesData = data;
            ...
            <div class="modal-body">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between border-1 border-bottom pb-3 mb-3">
                            <div class="hospital_logo">
                                <img src="../assets/img/logo.png" class="logo-white" alt="logo">
                            </div>
                            <div class="hospital_info">
                                <div class="py-1 px-2 text-end">
                                    <div class="">Address : 25 King Street, CA</div>
                                    <div class="">Phone No : 89562423934</div>
                                    <div class="">Email : cognsihealth@gmail.com</div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="mb-1"> Dr. Arjun </p>
                                    <p class="mb-0"> MD Cardiologist. MBBS,MS</p>
                                </div>
                            </div>

                            <div class="text-lg-end">
                                <p class="text-dark mb-1"> Department : <span class="text-body"> Cardiology OP</span>
                                </p>
                                <p class="text-dark mb-1"> Prescribed on : <span class="text-body"> 25 Jan 2025, 09:00
                                        AM</span> </p>
                        ...
                        <div class="pb-3 mb-3 border-1 border-bottom">
                            <h6 class="mb-1 fs-16 fw-semibold">Advice</h6>
                            <p> An account of the present illness, which includes the circumstances surrounding the
                                onset of recent health changes and the chronology of subsequent events that have led the
                                patient to seek medical care, is essential to understanding the course of the disease
                                process. Medications are listed in the medical history because they may play a role in
                                the current illness. </p>
                        ...
                        <div
                            ...
                            <div class="">
                                <img src="../assets/img/icons/signature-img.svg" alt="" class="img-fluid ">
                                <h6 class="fs-14 fw-semibold"> Dr. Arjun </h6>
