                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">Consultation Fees
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">Admission Charges
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">Lab Test Charges
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\hims\resources\views/admin/setup/income_head.blade.php ENDPATH**/ ?>