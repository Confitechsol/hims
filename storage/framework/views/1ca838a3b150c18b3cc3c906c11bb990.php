...
<div class="modal fade" id="<?php echo e($id); ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form action="<?php echo e($action); ?>" method="POST" id="<?php echo e($id); ?>-form">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp82\htdocs\hims\resources\views/components/modals/form-modal.blade.php ENDPATH**/ ?>