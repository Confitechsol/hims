                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <h6 class="fs-13 fw-bold mb-1">
                                                    <?php echo e($ipd->doctor ? $ipd->doctor->name . '(' . $ipd->doctor->doctor_id . ')' : '--'); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <a href="<?php echo e(route('ipd.prescription.edit', $prescription->id)); ?>"
                                                                class="fs-18 p-1 btn btn-icon btn-sm btn-soft-warning rounded-pill"
                                                                data-bs-toggle="tooltip"
                                                                title="Edit">
                                                                <i class="fa-solid fa-pencil"></i>
                                                            </a>
                                                            <a href="<?php echo e(route('ipd.prescription.print', $prescription->id)); ?>"
                                                                target="_blank"
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp-8.2\htdocs\hims\resources\views/admin/ipd/ipd_view.blade.php ENDPATH**/ ?>