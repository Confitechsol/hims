...
<div class="row justify-content-center">
    <div class="col-md-11">
        <div class="card shadow-sm border-0 mt-4">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('pharmacy.billing.store')); ?>" method="POST" id="pharmacyBillForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="<?php echo e(route('pharmacy.billing.index')); ?>" class="btn btn-secondary">Cancel</a>
...
function fetchMedicines(categoryId, medicineSelect) {
    fetch(`<?php echo e(route('pharmacy.api.medicines')); ?>?category_id=${categoryId}`)
        .then(response => response.json())
        .then(data => {
...
function fetchBatchDetails(batchId, row) {
    fetch(`<?php echo e(route('pharmacy.api.batch-details')); ?>?batch_id=${batchId}`)
        .then(response => response.json())
        .then(data => {
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u676663263/domains/confitechone.com/public_html/hims/resources/views/admin/pharmacy/billing/create.blade.php ENDPATH**/ ?>