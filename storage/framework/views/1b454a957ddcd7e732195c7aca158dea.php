                ...
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-sm-center justify-content-between flex-wrap gap-2 w-100">
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-2">
                            ...
                            <a href="<?php echo e(route('items')); ?>" class="btn btn-outline-primary d-inline-flex align-items-center">
                                ...
                                <div class="modal-body">
                                    <div class="row align-items-center gy-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select" id="supplier" name="supplier" required>
                                                ...
                                                <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($supplier->id); ?>"><?php echo e($supplier->item_supplier); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="store" name="store" class="form-select">
                                                ...
                                                <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($store->id); ?>"><?php echo e($store->item_store); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="date" name="date" id="date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                                        </div>
                        ...
                        <table class="table border">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($stock->item->name ?? 'N/A'); ?></td>
                                        <td><?php echo e($stock->itemCategory->item_category ?? 'N/A'); ?></td>
                                        <td><?php echo e($stock->supplier->item_supplier ?? 'N/A'); ?></td>
                                        <td><?php echo e($stock->store->item_store ?? 'N/A'); ?></td>
                                        <td><?php echo e($stock->date ? \Carbon\Carbon::parse($stock->date)->format('d-M-Y') : 'N/A'); ?></td>
                                        <td><?php echo e($stock->message ?? '-'); ?></td>
                                        <td><?php echo e($stock->quantity); ?></td>
                                        <td><?php echo e(number_format($stock->purchase_price, 2)); ?></td>
                                        <td><?php echo e($stock->expiry_date ? \Carbon\Carbon::parse($stock->expiry_date)->format('d-M-Y') : '-'); ?></td>
                                        <td><?php echo e($stock->salvage_value ?? '-'); ?></td>
                                        <td><?php echo e($stock->useful_life ?? '-'); ?></td>
                                        <td><?php echo e($stock->annual_depreciation ?? '-'); ?></td>
                                        <td>
                                            <div class="btn-group">
                                                <a href="javascript:void(0);" 
                                                   class="fs-18 p-1 btn btn-icon btn-sm btn-soft-info rounded-pill editStockBtn"
                                                   data-id="<?php echo e($stock->id); ?>" data-bs-toggle="tooltip" title="Edit">
                                                    <i class="ti ti-pencil"></i>
                                                </a>

                                                <a href="javascript:void(0);" class="fs-18 p-1 btn btn-icon btn-sm btn-soft-danger rounded-pill"
                                                   onclick="if(confirm('Are you sure you want to delete this stock?')) { document.getElementById('delete-stock-<?php echo e($stock->id); ?>').submit(); }"
                                                   data-bs-toggle="tooltip" title="Delete">
                                                    <i class="ti ti-trash"></i>
                                                </a>
                                                <form id="delete-stock-<?php echo e($stock->id); ?>" action="<?php echo e(route('itemstock.destroy', $stock->id)); ?>" method="POST" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $(document).on('click', '#addNewStockBtn', function () {
        ...
        form.action = "<?php echo e(route('itemstock.store')); ?>";
    ...
    $(document).on('click', '.editStockBtn', function () {
        ...
        $.ajax({
            url: "<?php echo e(route('itemstock.edit', ':id')); ?>".replace(':id', id),
            method: 'GET',
            success: function (data) {
                ...
                form.action = "<?php echo e(route('itemstock.update', ':id')); ?>".replace(':id', id);
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/inventory/inventory_details.blade.php ENDPATH**/ ?>