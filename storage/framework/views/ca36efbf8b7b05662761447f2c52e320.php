                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <button
                                                                    ...
                                                                    data-name="<?php echo e($expense->name); ?>"
                                                                    data-invoice_number="<?php echo e($expense->invoice_no); ?>"
                                                                    data-date="<?php echo e(optional($expense->date)?->format('Y-m-d') ?? $expense->date); ?>"
                                                                    data-description="<?php echo e($expense->note); ?>"
                                                                    data-amount="<?php echo e($expense->amount); ?>"
                                                                    data-expense_name="<?php echo e($expense->expenseHead->id ?? ''); ?>"
                                                                    data-attach_document="<?php echo e($expense->attach_document ?? ''); ?>">
                                                                    <i class="ti ti-pencil"></i>
                                                                </button>
                                                                <form method="POST" action="<?php echo e(route('expense.delete', $expense->id)); ?>" class="ms-2">
                                                                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.form-modal','data' => ['type' => 'add','id' => 'createModal','title' => 'Add Expense','action' => ''.e(route('expense.create')).'','fields' => [
            [
                'name' => 'expense_name',
                'label' => 'Expense Head',
                'type' => 'select',
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'add','id' => 'createModal','title' => 'Add Expense','action' => ''.e(route('expense.create')).'','fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            [
                'name' => 'expense_name',
                'label' => 'Expense Head',
                'type' => 'select',
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal66ca70ec79ff22faa62f501a1b49a88a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66ca70ec79ff22faa62f501a1b49a88a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.form-modal','data' => ['method' => 'put','type' => 'edit','id' => 'edit_modal','title' => 'Edit Expense','action' => ''.e(url('/expense/update')).'','fields' => [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['method' => 'put','type' => 'edit','id' => 'edit_modal','title' => 'Edit Expense','action' => ''.e(url('/expense/update')).'','fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            ['name' => 'id', 'type' => 'hidden', 'required' => true],
            [
                'name' => 'expense_name',
                'label' => 'Expense Head',
