                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('blood-bank-products.store')); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($product->name); ?> 
                                                        </h6>
                                                    </td>
                                                    <td><?php echo e($product->is_blood_group == 1 ? 'Blood Group' : 'Component'); ?></td>
                                                    <td>
                                                        <a href="javascript:void(0);" 
                                                        onclick="openProductModal(this)" 
                                                        data-product-id="<?php echo e($product->id); ?>" 
                                                        data-product-name="<?php echo e($product->name); ?>" 
                                                        data-product-type="<?php echo e($product->is_blood_group); ?>"
...
function openProductModal(el) {
    ...
    form.action = "<?php echo e(url('blood-bank-products/update')); ?>/" + id; // update route
...
function deleteProduct(id) {
    if (confirm("Are you sure you want to delete this product?")) {
        ...
        form.action = "<?php echo e(url('blood-bank-products/destroy')); ?>/" + id; // delete route
        form.submit();
    }
}
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/setup/product.blade.php ENDPATH**/ ?>