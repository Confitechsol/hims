<?php $__env->startSection('content'); ?>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('operations.store')); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $operations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td>
                                                            <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($operation->operation); ?></h6>
                                                        </td>

                                                        <td>
                                                            <?php echo e($operation->category->category ?? 'N/A'); ?>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);"
                                                                ...
                                                                data-operation-id="<?php echo e($operation->id); ?>"
                                                                data-operation-name="<?php echo e($operation->operation); ?>"
                                                                data-operation-category="<?php echo e($operation->category_id); ?>">
                                                            ...
                                                            <a href="javascript:void(0);"
                                                                onclick="deleteOperation(<?php echo e($operation->id); ?>)"
    ...
    <script>
        function openOperationModal(el) {
            ...
            form.action = "<?php echo e(url('operations/update')); ?>/" + id; // route to update
    ...
    function deleteOperation(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = "<?php echo e(url('operations/destroy')); ?>/" + id;
                form.submit();
            }
        }
    </script>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u676663263/domains/confitechone.com/public_html/hims/resources/views/admin/setup/operation.blade.php ENDPATH**/ ?>