                            ...
                            <tbody class="list">
                                <?php $__currentLoopData = $beds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="floor"><?php echo e($bed->bedGroup->floor ?? 'N/A'); ?></td>
                                        <td class="status"><?php echo e($bed->is_active == "yes" ? 'Available' : 'Alloted'); ?></td>
                                    </tr>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\bed\status.blade.php ENDPATH**/ ?>