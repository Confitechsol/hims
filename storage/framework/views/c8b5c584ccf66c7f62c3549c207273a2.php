                                    ...
                                    <div class="modal fade" id="add_issue_item" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                            <div class="modal-content">
                                                <form method="POST" action="<?php echo e(route('issue-items.store')); ?>" id="issueItemForm" enctype="multipart/form-data">
                                                    <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row gy-3 align-items-center">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <select name="item_category_id" id="item_category" class="form-select" required>
                                                                    ...
                                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($category->id); ?>"><?php echo e($category->item_category); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <input type="text" name="issue_by" id="issue_by" value="<?php echo e(Auth::user()->username ?? ''); ?>" class="form-control" readonly>
                                                            </div>

                                                            
                                                            <div class="col-md-3">
                                                                <label for="issue_date" class="form-label fw-bold">Issue Date</label>
                                                                <input type="date" name="issue_date" id="issue_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                                                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table-nowrap">
                                <table class="table border">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $itemIssues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td><?php echo e($issue->item->name ?? '-'); ?></td>
                                                <td><?php echo e($issue->category->item_category ?? '-'); ?></td>
                                                <!-- <td><?php echo e($issue->department_id ?? '-'); ?></td> -->
                                                <td><?php echo e(ucfirst($issue->return_date)); ?></td>
                                                <td>
                                                    <?php echo e($issue->issuedTo ? $issue->issuedTo->name . ' ' . $issue->issuedTo->surname . ' (' . $issue->issuedTo->employee_id . ')' : '-'); ?>

                                                </td>

                                                <td><?php echo e($issue->issue_by ?? '-'); ?></td>
                                                <td><?php echo e($issue->quantity ?? 0); ?></td>
                                                <td><?php echo e($issue->note ?? '-'); ?></td>

                                                <td>
                                                    <?php if($issue->is_returned === 'yes'): ?>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" 
                                                        ...
                                                        data-id="<?php echo e($issue->id); ?>" data-bs-toggle="tooltip" title="Edit">
                                                        <i class="ti ti-pencil"></i>
                                                    </a>

                                                    <a href="javascript:void(0);" 
                                                        class="fs-18 p-1 btn btn-icon btn-sm btn-soft-danger rounded-pill"
                                                        onclick="if(confirm('Are you sure you want to delete this issue record?')) { document.getElementById('delete-issue-<?php echo e($issue->id); ?>').submit(); }"
                                                        data-bs-toggle="tooltip" title="Delete">
                                                        <i class="ti ti-trash"></i>
                                                    </a>

                                                    <form id="delete-issue-<?php echo e($issue->id); ?>" 
                                                        action="<?php echo e(route('issue-items.destroy', $issue->id)); ?>" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    categorySelect.addEventListener('change', function() {
        ...
        if (categoryId) {
             fetch(`<?php echo e(route('get.items', ':id')); ?>`.replace(':id', categoryId))
    ...
    $('#department_id').on('change', function () {
        ...
        if (deptId) {
            $.ajax({
                url: "<?php echo e(route('get-staff-by-department')); ?>",
                type: "GET",
...
$(document).on('click', '.editIssueBtn', function () {
    ...
    $.ajax({
        url: "<?php echo e(route('issue-items.edit', ':id')); ?>".replace(':id', id),
        method: 'GET',
        success: function (data) {
            if (!data || !data.issue) {
            ...
            form.attr('action', "<?php echo e(route('issue-items.update', ':id')); ?>".replace(':id', id));
            ...
            $.ajax({
                url: "<?php echo e(route('get-items-by-category')); ?>",
                type: 'GET',
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/inventory/issue_item.blade.php ENDPATH**/ ?>