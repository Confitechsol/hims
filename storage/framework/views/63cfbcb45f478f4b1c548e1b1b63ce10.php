...
<?php $__env->startSection('content'); ?>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="purposeForm" method="POST" action="<?php echo e(route('purposes.store')); ?>">
                                                                    <?php echo csrf_field(); ?>
                                                    ...
                                                    <tbody>
                                                         <?php $__currentLoopData = $purposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $purpose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($purpose->visitors_purpose); ?></h6>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="javascript:void(0);" 
                                                                        ...
                                                                        data-purpose-id="<?php echo e($purpose->id); ?>" 
                                                                        data-purpose-name="<?php echo e($purpose->visitors_purpose); ?>" 
                                                                        data-purpose-description="<?php echo e($purpose->description); ?>"
                                                                    ...
                                                                    title="Delete"
                                                                    onclick="if(confirm('Are you sure you want to delete this purpose ?')) { document.getElementById('delete-purpose -<?php echo e($purpose ->id); ?>').submit(); }">
                                                                        <i class="ti ti-trash"></i>
                                                                    </a>

                                                                    <form id="delete-purpose -<?php echo e($purpose ->id); ?>" 
                                                                        action="<?php echo e(route('purposes.destroy', $purpose ->id)); ?>" 
        ...
        <script>
            function openPurposeModal(el) {
                ...
                form.action = "<?php echo e(url('purpose')); ?>/update/" + id; // route to update
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/setup/visitorspurpose.blade.php ENDPATH**/ ?>