            ...
            <div class="card shadow-sm border-0 mt-4">
                <div class="card-header" style="background: linear-gradient(-90deg, #75009673 0%, #CB6CE673 100%)">
                    <h5 class="mb-0" style="color: #750096">
                        <i class="fas fa-shopping-cart me-2"></i>Medicines Need Reordering
                    </h5>
                </div>
                ...
                <div class="card-body">
                    <div class="alert alert-warning">
                        ...
                        These medicines have reached their reorder level and should be ordered soon.
                    </div>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-warning"><?php echo e($medicine->total_quantity ?? 0); ?></span>
                                        </td>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="7" class="text-center text-success py-4">
                                            ...
                                            <p class="mt-2">All medicines are sufficiently stocked!</p>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\pharmacy\needs-reorder.blade.php ENDPATH**/ ?>