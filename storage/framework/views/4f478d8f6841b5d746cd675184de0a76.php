                                ...
                                <div class="card-body">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('radiology-category.store')); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $radiologyCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td>
                                                            <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($category->name); ?>

                                                            </h6>
                                                        </td>
                                                        <td>
                                                            <form
                                                                action="<?php echo e(route('radiology-category.updateStatus', [$category->id])); ?>"
                                                                method="post">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="form-check form-switch mb-0">
                                                                    <input class="form-check-input category-status-toggle"
                                                                        ...
                                                                        <?php echo e($category->is_active == 'yes' ? 'checked' : ''); ?>>
                                                                </div>
                                                            </form>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                ...
                                                                <form
                                                                    action="<?php echo e(route('radiology-category.delete', [$category->id])); ?>"
                                                                    id="delete-form-<?php echo e($category->id); ?>" method="POST">
                                                                    <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <a href="javascript: void(0);"
                                                                        ...
                                                                        data-form-id="delete-form-<?php echo e($category->id); ?>">
                                    ...
                                    <div class="modal fade" id="edit_radiology_category" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('radiology-category.update')); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u676663263/domains/confitechone.com/public_html/hims/resources/views/admin/setup/radiology_category.blade.php ENDPATH**/ ?>