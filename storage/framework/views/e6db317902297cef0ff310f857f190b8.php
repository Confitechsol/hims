...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-actions.actions','data' => ['id' => 'bed_type','name' => 'Bed Type']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'bed_type','name' => 'Bed Type']); ?>
...
<?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="fs-18 p-1 btn btn-icon btn-sm btn-soft-success rounded-pill"
                                            data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?php echo e($type->id); ?>"
                                        ...
                                        <button class="fs-18 p-1 btn btn-icon btn-sm btn-soft-danger rounded-pill"
                                            ...
                                            data-id="<?php echo e($type->id); ?>" data-name="<?php echo e($type->name); ?>">
                ...
                <div class="mt-3" id="pagination-wrapper">
                    ...
                    <?php if($bedTypes->onFirstPage()): ?>
                        <button class="btn btn-outline-secondary btn-sm me-1" disabled>« Prev</button>
                    <?php else: ?>
                        <a href="<?php echo e($bedTypes->previousPageUrl()); ?><?php echo e(request('perPage') ? '&perPage=' . request('perPage') : ''); ?>"
                    ...
                    <?php for($page = 1; $page <= $lastPage; $page++): ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($bedTypes->url($page)); ?><?php echo e(request('perPage') ? '&perPage=' . request('perPage') : ''); ?>"
                                class="btn btn-outline-secondary btn-sm me-1">
                                <?php echo e($page); ?>
                    ...
                    <?php if($bedTypes->hasMorePages()): ?>
                        <a href="<?php echo e($bedTypes->nextPageUrl()); ?><?php echo e(request('perPage') ? '&perPage=' . request('perPage') : ''); ?>"
    ...
    <div class="modal fade" id="createModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="<?php echo e(route('bed-types.store')); ?>" method="POST" class="modal-content">
                <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="editModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="<?php echo e(route('bed-types.update')); ?>" method="POST" class="modal-content">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="<?php echo e(route('bed-types.destroy')); ?>" method="POST" class="modal-content">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            createAjaxTable({
                apiUrl: "<?php echo e(route('bed-types.index')); ?>",
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\bed-type\index.blade.php ENDPATH**/ ?>