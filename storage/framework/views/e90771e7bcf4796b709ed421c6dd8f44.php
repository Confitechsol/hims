...
<html lang="en">
  <head>
    ...
    <title><?php echo e($IpdPatient->patient['patient_name']); ?></title>
  </head>
  <style>
    ...
    <div class="main_box">
      ...
      <div class="top_head">
        <div class="first_logo">
          <img src="<?php echo e(asset('assets/images/logo.webp')); ?>" alt="LOGO1" style="height: 50px">
      ...
      <div class="admission_info">
        ...
        <div class="admission_item">
          <p>
            <b>ADMISSION DATE.</b> : <?php echo e(\Carbon\Carbon::parse($IpdPatient->created_at)->format('d-m-Y') ?? ''); ?>

          </p>
        </div>
        <div class="admission_item">
          <p>
            <b>ADMISSION TIME</b> : <span class="red"><?php echo e(\Carbon\Carbon::parse($IpdPatient->created_at)->format('h:i') ?? ''); ?> <?php echo e(\Carbon\Carbon::parse($IpdPatient->created_at)->format('A') ?? ''); ?></span>
          </p>
        </div>
      </div>
        ...
        <div class="patient_details">
          ...
          <div class="patient_items">
            ...
            <div class="patient_data">
              <?php echo e($IpdPatient->patient['patient_name']); ?>
        ...
        <div class="patient_details">
          <div class="patient_box">
            <div class="patient_items">
              ...
              :
              <div class="patient_data">
                <?php echo e($IpdPatient->patient['age']); ?> y
              </div>
            </div>
            <div class="patient_items">
              <div class="patient_head">
              ...
              :
              <div class="patient_data">
                <?php echo e($IpdPatient->patient['gender']); ?>
          ...
          <div class="patient_items">
            ...
            :
            <div class="patient_data">
              <?php echo e($IpdPatient->patient['marital_status']); ?>
          ...
          <div class="patient_items">
            ...
            :
            <div class="patient_data">
              <?php echo e($IpdPatient->patient['mobileno']); ?>
      ...
      <div class="patient_info">
        ...
        <div class="patient_details">
          ...
          <div class="patient_items">
            ...
            :
            <div class="patient_data">
              <?php echo e($IpdPatient->patient['guardian_phone']); ?>
      ...
      <div class="patient_info">
        ...
        <div class="patient_details">
          ...
          <div class="patient_box">
            ...
            <div class="patient_items">
              ...
              :
              <div class="patient_data">
                <?php echo e($IpdPatient->ipd['bedDetail']['name'] ?? ''); ?>
            ...
            <div class="patient_items">
              ...
              :
              <div class="patient_data">
                <?php echo e($IpdPatient->ipd['bedDetail']['bedGroup']['bed_cost'] ?? ''); ?>
          ...
          <div class="patient_items">
            ...
            :
            <div class="patient_data">
              Dr. <?php echo e($IpdPatient->doctor['name']); ?> <?php echo e($IpdPatient->doctor['surname']); ?> (<?php echo e($IpdPatient->doctor['registration_no']); ?>)
            </div>
          </div>
        ...
        <div class="patient_details">
          ...
          <div class="patient_items">
            ...
            :
            <div class="patient_data">
              <?php echo e($IpdPatient->ipd['bedDetail']['bedGroup']['name'] ?? ''); ?>
      ...
      <div class="patient_info">
        ...
        <div class="patient_details">
          ...
          <div class="patient_items">
            ...
            :
            <div class="patient_data">
              <?php echo e($IpdPatient->ipd->organisation['organisation_name']); ?>
      ...
      <div class="admission_info">
        <div class="admission_item">
          <p>
            <b>Date of Admission </b>: <?php echo e(\Carbon\Carbon::parse($IpdPatient->created_at)->format('d-m-Y') ?? ''); ?>

          </p>
        </div>
        <div class="admission_item">
          <p>
            <b>ADMISSION TIME.</b> : <?php echo e(\Carbon\Carbon::parse($IpdPatient->created_at)->format('h:i') ?? ''); ?> <?php echo e(\Carbon\Carbon::parse($IpdPatient->created_at)->format('A') ?? ''); ?>
        ...
        <div class="admission_item">
          <p>
            <b>BED No</b> : <?php echo e($IpdPatient->ipd['bedDetail']['name'] ?? ''); ?>
      ...
      <div class="wreeti_sig">
        ...
        <p><b>DATE : </b></p>
        <p><b><?php echo e(\Carbon\Carbon::parse($IpdPatient->created_at)->format('d-m-Y') ?? ''); ?></b></p>
      </div>
      <script>
  ...
  </html><?php /**PATH C:\xampp\htdocs\hims\resources\views/pdf/invoice.blade.php ENDPATH**/ ?>