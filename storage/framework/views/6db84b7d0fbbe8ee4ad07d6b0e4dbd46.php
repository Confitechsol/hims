                            ...
                            <div class="card-body">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="sourceForm" method="POST" action="<?php echo e(route('sources.store')); ?>">
                                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <th scope="row"><?php echo e($index + 1); ?></th>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($source->source); ?></h6>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0);" 
                                                            ...
                                                            data-source-name="<?php echo e($source->source); ?>" 
                                                            data-source-description="<?php echo e($source->description); ?>"
                                                        ...
                                                        <a href="javascript:void(0);" 
                                                            ...
                                                            title="Delete"
                                                            onclick="if(confirm('Are you sure you want to delete this source ?')) { document.getElementById('delete-source-<?php echo e($source->id); ?>').submit(); }">
                                                            <i class="ti ti-trash"></i>
                                                        </a>

                                                        <form id="delete-source-<?php echo e($source->id); ?>" 
                                                            action="<?php echo e(route('sources.destroy', $source->id)); ?>" 
...
<script>
    function openSourceModal(el) {
        ...
        form.action = "<?php echo e(url('sources')); ?>/update/" + id; // route to update
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/setup/sources.blade.php ENDPATH**/ ?>