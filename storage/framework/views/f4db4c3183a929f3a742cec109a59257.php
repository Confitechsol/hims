                                ...
                                <div class="card-body">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('income-head.store')); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <?php $__empty_1 = true; $__currentLoopData = $incomeHeads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incomeHead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr>
                                                        <td>
                                                            <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($incomeHead->income_category); ?></h6>
                                                            <small class="text-muted"><?php echo e($incomeHead->description); ?></small>
                                                        </td>
                                                        <td>
                                                            <a href="javascript:void(0);" 
                                                            class="fs-18 p-1 btn btn-icon btn-sm btn-soft-success rounded-pill edit-btn"
                                                            data-id="<?php echo e($incomeHead->id); ?>"
                                                            data-name="<?php echo e($incomeHead->income_category); ?>"
                                                            data-desc="<?php echo e($incomeHead->description); ?>">
                                                                <i class="ti ti-pencil"></i>
                                                            </a>
                                                            <a href="javascript:void(0);"
                                                                onclick="deleteIncomeHead(<?php echo e($incomeHead->id); ?>)"
...
<script>
    ...
    document.querySelectorAll(".edit-btn").forEach(button => {
        button.addEventListener("click", function () {
            ...
            form.action = '<?php echo e(url('income-head/update')); ?>/' + id;
    ...
    function deleteIncomeHead(id) {
        if (confirm("Are you sure you want to delete this Income Head?")) {
            ...
            form.action = "<?php echo e(url('income-head/destroy')); ?>/" + id;
            form.submit();
        }
    }
</script>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\income_head.blade.php ENDPATH**/ ?>