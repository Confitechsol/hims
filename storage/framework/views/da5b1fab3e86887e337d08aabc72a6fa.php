                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $specialists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form
                                                                action="<?php echo e(route('specialist.updateSpecialistStatus', [$specialist->id])); ?>"
                                                                method="post">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="form-check form-switch mb-0">
                                                                    <input class="form-check-input status-toggle"
                                                                        ...
                                                                        data-id="<?php echo e($specialist->id); ?>"
                                                                        <?php echo e($specialist->is_active == 'yes' ? 'checked' : ''); ?>>
                                                                </div>
                                                            </form>
                                                        </td>
                                                        <td>
                                                            <a href="javascript: void(0);"
                                                                ...
                                                                data-id="<?php echo e($specialist->id); ?>"
                                                                data-name="<?php echo e($specialist->specialist_name); ?>">
                                                                <i class="ti ti-pencil"></i></a>
                                                            <form
                                                                action="<?php echo e(route('specialist.deleteSpecialist', [$specialist->id])); ?>"
                                                                class="d-inline" id="delete-form-<?php echo e($specialist->id); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                <?php echo method_field('DELETE'); ?>
                                                                <a href="javascript: void(0);"
                                                                    class="fs-18 p-1 btn btn-icon btn-sm btn-soft-danger rounded-pill delete-button"
                                                                    data-specialist-id="<?php echo e($specialist->id); ?>"
                                                                    data-specialist-name="<?php echo e($specialist->specialist_name); ?>"
                                                                    data-form-id="delete-form-<?php echo e($specialist->id); ?>">
                                    ...
                                    <div class="modal fade" id="edit_specialist" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('specialist.updateSpecialist')); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/setup/specialist.blade.php ENDPATH**/ ?>