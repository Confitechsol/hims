                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('finding-category.storeCategory')); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $findingCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td>
                                                            <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($category->category); ?>
                                                        ...
                                                        <td>
                                                            <a href="javascript: void(0);"
                                                                ...
                                                                data-name="<?php echo e($category->category); ?>">
                                                                <i class="ti ti-pencil"></i></a>
                                                            <form
                                                                action="<?php echo e(route('finding-category.deleteCategory', [$category->id])); ?>"
                                    ...
                                    <div class="modal fade" id="edit_finding_category" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('finding-category.updateCategory')); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\finding_category.blade.php ENDPATH**/ ?>