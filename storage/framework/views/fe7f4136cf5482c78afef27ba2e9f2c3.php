<?php $__env->startSection('content'); ?>
        ...
        <div class="col-md-11">
            <div class="card shadow-sm border-0 mt-4">
                <div class="card-header" style="background: linear-gradient(-90deg, #75009673 0%, #CB6CE673 100%)">
                    <h5 class="mb-0" style="color: #750096"><i class="fas fa-cogs me-2"></i>Department List</h5>
                </div>
                                        ...
                                        <div class="page_btn d-flex">
                                            <div class="text-end d-flex">
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#add_department"><i
                                                        class="ti ti-plus me-1"></i>Add Department</a>
                                            </div>
                                            <!-- Modal -->
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form
                                                                action="<?php echo e(route('department.updateStatus', [$department->id])); ?>"
                                                                method="post">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="form-check form-switch mb-0">
                                                                    <input class="form-check-input status-toggle"
                                                                        ...
                                                                        <?php echo e($department->is_active == 'yes' ? 'checked' : ''); ?>>
                                                                </div>
                                                            </form>
                                                        </td>
                                                        <td>
                                                            <a href="javascript: void(0);"
                                                                ...
                                                                data-id="<?php echo e($department->id); ?>"
                                                                data-name="<?php echo e($department->department_name); ?>">
                                                                <i class="ti ti-pencil"></i></a>
                                                            <form
                                                                action="<?php echo e(route('department.delete', [$department->id])); ?>"
                                                                class="d-inline" id="delete-form-<?php echo e($department->id); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                ...
                                                                <a href="javascript: void(0);"
                                                                    ...
                                                                    data-department-name="<?php echo e($department->department_name); ?>"
                                                                    data-form-id="delete-form-<?php echo e($department->id); ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var editModal = document.getElementById('edit_department');
        ...
        document.querySelectorAll('.delete-button').forEach(input => {
            input.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    text: `Delete Department ${departmentName}(${departmentId})`,
                    icon: 'warning',
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\department.blade.php ENDPATH**/ ?>