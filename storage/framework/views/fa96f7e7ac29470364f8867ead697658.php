        ...
        <div class="content pb-0">
            ...
            <div class="row">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <!-- <a href="<?php echo e(route('itemstock.edit', $stock->id)); ?>" class="btn btn-sm btn-warning">Edit</a> -->
                            ...
                            <a href="javascript:void(0);" class="fs-18 p-1 btn btn-icon btn-sm btn-soft-danger rounded-pill " 
                                onclick="if(confirm('Are you sure you want to delete this stock ?')) { document.getElementById('delete-source-<?php echo e($stock->id); ?>').submit(); }"
                                  data-bs-toggle="tooltip" title="delete">
                                    <i class="ti ti-trash"></i>
                            </a>
                                <form id="delete-source-<?php echo e($stock->id); ?>"  action="<?php echo e(route('itemstock.destroy', $stock->id)); ?>" method="POST" style="display: none;">
                                    <?php echo csrf_field(); ?>
...
<script>
    ...
    btn.addEventListener('click', function () {
        ...
        fetch(`<?php echo e(url('inventory')); ?>/${id}/edit`)
            ...
            .then(data => {
                ...
                form.action = `<?php echo e(url('inventory/update')); ?>/${stock.id}`;
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\inventory\inventory_detailsOld.blade.php ENDPATH**/ ?>