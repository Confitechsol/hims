                                ...
                                <div class="card-body">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('radiology-parameter.store')); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="row gy-3 mb-2">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select name="unit" onchange=""
                                                                            ...
                                                                            <?php $__currentLoopData = $unitData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $radiologyParameters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parameter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td><?php echo e($units[$parameter->id]->name ?? '-'); ?></td>
                                                        ...
                                                        <td>
                                                            <a href="javascript: void(0);"
                                                                ...
                                                                data-unit="<?php echo e($parameter->unit); ?>"
                                                                ...
                                                                data-gender="<?php echo e($parameter->gender); ?>">
                                                                <i class="ti ti-pencil"></i></a>
                                                            <form
                                                                action="<?php echo e(route('radiology-parameter.delete', [$parameter->id])); ?>"
                                                                id="delete-form-<?php echo e($parameter->id); ?>" method="POST"
                                                                class="d-inline">
                                                                <?php echo csrf_field(); ?>
                                                                <?php echo method_field('DELETE'); ?>
                                                                <a href="javascript: void(0);"
                                                                    class="fs-18 p-1 btn btn-icon btn-sm btn-soft-danger rounded-pill delete-button"
                                                                    data-parameter-id="<?php echo e($parameter->id); ?>"
                                                                    data-parameter-name="<?php echo e($parameter->name); ?>"
                                                                    data-form-id="delete-form-<?php echo e($parameter->id); ?>">
                                    ...
                                    <div class="modal fade" id="edit_radiology_parameter" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('radiology-parameter.update')); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u676663263/domains/confitechone.com/public_html/hims/resources/views/admin/setup/radiology_parameter.blade.php ENDPATH**/ ?>