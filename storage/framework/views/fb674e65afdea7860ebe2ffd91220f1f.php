...
function deleteOperation(id) {
    if (confirm("Are you sure you want to delete this operation?")) {
        ...
        form.action = "<?php echo e(url('operations/destroy')); ?>/" + id; // adjust route if needed
        form.submit();
    }
}
</script>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/setup/operation.blade.php ENDPATH**/ ?>