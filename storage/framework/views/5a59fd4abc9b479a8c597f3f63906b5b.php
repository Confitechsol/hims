                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text">
                        ...
                        <div class="text-center mb-4">
                            <img src="<?php echo e($logo_image); ?>" class="logowidth">
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="form-bottom">
                                ...
                                <form class="" action="#" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if(session('usernameError')): ?>
                                            <div class="text-danger"><?php echo e(session('usernameError')); ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <input name="user" type="hidden" value="patient">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <button type="submit" class="btn">Submit</button>
                                        <a href="<?php echo e(route('userLogin')); ?>" class="forgot fs-4"><i class="fa fa-key"></i>
                                            User Login</a>
                                    </div>
                                </form>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\hims\resources\views\home\ufpassword.blade.php ENDPATH**/ ?>