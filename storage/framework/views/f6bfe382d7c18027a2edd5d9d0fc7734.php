            ...
            <div class="card shadow-sm border-0 mt-4">
                <div class="card-header" style="background: linear-gradient(-90deg, #75009673 0%, #CB6CE673 100%)">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0" style="color: #750096"><i class="fas fa-cogs me-2"></i> Expense Group Report </h5>
                ...
                <div class="card-body">
                    <form action="">
                        <div class="row align-items-center gy-4">
                            ...
                            <div class="col-md-4">
                                <label for="income_head" class="form-label">Search Income Head <span
                                        class="text-danger">*</span></label>
                                <select name="income_head" id="income_head" class="form-select">
                                    <option value="" selected disabled>Select</option>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\hims\resources\views/admin/finance/expense-group-report.blade.php ENDPATH**/ ?>