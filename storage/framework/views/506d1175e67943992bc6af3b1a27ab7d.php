                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header rounded-0"
                                                            ...
                                                            <h5 class="modal-title" id="addSpecializationLabel">Add Finding Category
                                                            </h5>
                                                                    ...
                                                                    <div class="row gy-3 finding-category-row mb-2">
                                                                        ...
                                                                        <div class="col-md-11">
                                                                            ...
                                                                            <input type="text" name="finding_category"
                                                                                id="finding_category" class="form-control" />
                                                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">General Examination
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">Vitals
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">Cardiovascular System
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">Gynecological
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold">ENT / Oral Cavity
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <a href="javascript: void(0);"
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\hims\resources\views/admin/setup/finding_category.blade.php ENDPATH**/ ?>