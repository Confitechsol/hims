                            ...
                            <div class="card-body">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="complaintTypeForm" method="POST" action="<?php echo e(route('complaint-types.store')); ?>">
                                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $complaintTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $complaintType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <th scope="row"><?php echo e($index + 1); ?></th>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($complaintType->complaint_type); ?></h6>
                                                    </td>
                                                    <td><?php echo e($complaintType->description); ?></td>
                                                    <td>
                                                        <a href="javascript:void(0);" 
                                                            class="fs-18 p-1 btn btn-icon btn-sm btn-soft-info rounded-pill"
                                                            data-complaint-type-id="<?php echo e($complaintType->id); ?>" 
                                                            data-complaint-type-name="<?php echo e($complaintType->complaint_type); ?>" 
                                                            data-complaint-type-description="<?php echo e($complaintType->description); ?>"
                                                        ...
                                                        <a href="javascript:void(0);" 
                                                            ...
                                                            title="Delete"
                                                            onclick="if(confirm('Are you sure you want to delete this complaint type ?')) { document.getElementById('delete-complaint-type-<?php echo e($complaintType->id); ?>').submit(); }">
                                                            <i class="ti ti-trash"></i>
                                                        </a>

                                                        <form id="delete-complaint-type-<?php echo e($complaintType->id); ?>" 
                                                            action="<?php echo e(route('complaint-types.destroy', $complaintType->id)); ?>" 
...
<script>
    function openComplaintTypeModal(el) {
        ...
        form.action = "<?php echo e(url('complaintType')); ?>/update/" + id; // route to update
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/setup/complaintTypes.blade.php ENDPATH**/ ?>