                ...
                <div class="settings-wrapper d-flex">
                    ...
                    <div class="card flex-fill mb-0 border-0 bg-light-500 shadow-none">
                        ...
                        <div class="card-body px-0 mx-3">
                            <form action="<?php echo e(route('email-setting-save')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-radio-input m-0" id="phpMailer" value="php_mailer" type="radio" name="email_type" <?php echo e(old('type', $emailConfig->email_type ?? '') == 'php_mailer' ? 'checked' : ''); ?>>
                                            </div>
                                        </div>
                                ...
                                <div class="card shadow-none">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-radio-input m-0"  id="smtp" type="radio" value="smtp" name="email_type" <?php echo e(old('type', $emailConfig->email_type ?? '') == 'smtp' ? 'checked' : ''); ?>>
                                            </div>
                                        </div>
                        ...
                        <div id="smtpFields" class="mt-3" style="display: none;">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="smtp_server" id="smtp_server"
                                       value="<?php echo e(old('smtp_server', $emailConfig->smtp_server ?? '')); ?>">
                            </div>
                        
                            <div class="mb-3">
                                <label for="smtp_port">SMTP Port</label>
                                <input type="number" class="form-control" name="smtp_port" id="smtp_port"
                                       value="<?php echo e(old('smtp_port', $emailConfig->smtp_port ?? '')); ?>">
                            </div>
                        
                            <div class="mb-3">
                                <label for="smtp_username">SMTP Username</label>
                                <input type="text" class="form-control" name="smtp_username" id="smtp_username"
                                       value="<?php echo e(old('smtp_username', $emailConfig->smtp_username ?? '')); ?>">
                            </div>
                        
                            <div class="mb-3">
                                <label for="smtp_password">SMTP Password</label>
                                <input type="password" class="form-control" name="smtp_password" id="smtp_password"
                                       value="<?php echo e(old('smtp_password', $emailConfig->smtp_password ?? '')); ?>">
                            </div>
                        
                            <div class="mb-3">
                                <label for="ssl_tls">Encryption</label>
                                <select class="form-select" name="ssl_tls" id="ssl_tls">
                                    <option value="" <?php echo e(old('ssl_tls', $emailConfig->ssl_tls ?? '') == '' ? 'selected' : ''); ?>>None</option>
                                    <option value="ssl" <?php echo e(old('ssl_tls', $emailConfig->ssl_tls ?? '') == 'ssl' ? 'selected' : ''); ?>>SSL</option>
                                    <option value="tls" <?php echo e(old('ssl_tls', $emailConfig->ssl_tls ?? '') == 'tls' ? 'selected' : ''); ?>>TLS</option>
                                </select>
                            </div>
                        
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" name="smtp_auth" id="smtp_auth" value="1"
                                    <?php echo e(old('smtp_auth', $emailConfig->smtp_auth ?? false) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\email-setting.blade.php ENDPATH**/ ?>