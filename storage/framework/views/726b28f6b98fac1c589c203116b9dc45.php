<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        ...
        <!-- page header start -->
        <div class="mb-4">
            <h6 class="fw-bold mb-0 d-flex align-items-center"> <a href="<?php echo e(route('tpamanagement')); ?>" class="text-dark"> <i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <form method="POST" action="<?php echo e(route('tpa_details.destroy')); ?>" onsubmit="return confirmDeleteForm(event, 'Delete Item?', 'Are you sure you want to delete this item?');">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\tpa\tpa_details.blade.php ENDPATH**/ ?>