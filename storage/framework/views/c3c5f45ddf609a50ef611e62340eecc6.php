                ...
                <div class="col-12 d-flex">
                    <div class="card shadow-sm flex-fill w-100">
                          <div class="card-header" style="background: linear-gradient(-90deg, #75009673 0%, #CB6CE673 100%)">
                            <h5 class="mb-0" style="color: #750096"><i class="fas fa-cogs me-2"></i>Appointment Details</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="row align-items-center gy-3">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <label for="doctor_fees"
                                                                                class="form-label">Doctor Fees (INR)
                                                                                <span class="text-danger">*</span></label>
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\hims\resources\views/admin/appointment_details.blade.php ENDPATH**/ ?>