...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-actions.actions','data' => ['id' => 'company','name' => 'Company']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'company','name' => 'Company']); ?>
...
<?php endif; ?> 
                                    <div class="table-responsive" id="company">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $companys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14 fw-semibold"><?php echo e($item->id); ?></h6>
                                                        </h6>
                                                    </td>
                                                    ...
                                                    <td>
                                                         <button
                                                            ...
                                                            data-company_name="<?php echo e($item->company_name); ?>">
                                                            <i class="ti ti-pencil"></i>
                                                        </button>
                                                        <form action="<?php echo e(route('company-list.destroy')); ?>" method="POST" style="display:inline-block;" onsubmit="return confirmDeleteForm(event, 'Delete Company?', 'Are you sure you want to delete this company?');">
                                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="mt-3" id="pagination-wrapper">
                                    ...
                                    <?php if($companys->onFirstPage()): ?>
                                        <button class="btn btn-outline-secondary btn-sm me-1" disabled>« Prev</button>
                                    <?php else: ?>
                                        <a href="<?php echo e($companys->previousPageUrl()); ?><?php echo e(request('perPage') ? '&perPage=' . request('perPage') : ''); ?>"
                                    ...
                                    <?php for($page = 1; $page <= $lastPage; $page++): ?>
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e($companys->url($page)); ?><?php echo e(request('perPage') ? '&perPage=' . request('perPage') : ''); ?>"
                                                class="btn btn-outline-secondary btn-sm me-1">
                                                <?php echo e($page); ?>
                                    ...
                                    <?php if($companys->hasMorePages()): ?>
                                        <a href="<?php echo e($companys->nextPageUrl()); ?><?php echo e(request('perPage') ? '&perPage=' . request('perPage') : ''); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.form-modal','data' => ['type' => 'add','id' => 'createModal','title' => 'Add company','action' => ''.e(route('company-list.store')).'','repeatableGroup' => [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'add','id' => 'createModal','title' => 'Add company','action' => ''.e(route('company-list.store')).'','repeatable_group' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['name' => 'company_name', 'label' => 'Company Name', 'type' => 'text', 'required' => true,'size'=>'11']
        ]),'columns' => 2]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal66ca70ec79ff22faa62f501a1b49a88a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66ca70ec79ff22faa62f501a1b49a88a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.form-modal','data' => ['method' => 'put','type' => 'edit','id' => 'edit_modal','title' => 'Edit Company Name','action' => ''.e(route('company-list.update')).'','fields' => [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['method' => 'put','type' => 'edit','id' => 'edit_modal','title' => 'Edit Company Name','action' => ''.e(route('company-list.update')).'','fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['name' => 'id', 'type' => 'hidden', 'required' => true],
        ['name' => 'company_name', 'label' => 'Unit Name', 'type' => 'text', 'required' => true, 'size' => '12']
    ]),'columns' => 2]); ?>
<?php echo $__env->renderComponent(); ?>
...
document.addEventListener('DOMContentLoaded', function () {    
    createAjaxTable({
    apiUrl: "<?php echo e(route('company-list')); ?>",
    ...
    rowRenderer: function (item) {
        ...
        row.innerHTML = `
            ...
            <button
                ...
                <form action="<?php echo e(route('company-list.destroy')); ?>"
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views\admin\setup\company_list.blade.php ENDPATH**/ ?>