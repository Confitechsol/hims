...
$(document).ready(function() {
    ...
    $('#add_appointment').on('shown.bs.modal', function () {
        $.ajax({
            url: '<?php echo e(route("appointment.priorities")); ?>',
            type: 'GET',
            success: function(response) {
...
<?php echo $__env->make('layouts.adminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hims\resources\views/admin/appointment_details.blade.php ENDPATH**/ ?>