...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pharmacy_bill_detail', function (Blueprint $table) {
            ...
            $table->foreign('pharmacy_bill_basic_id')->references('id')->on('pharmacy_bill_basic')->onDelete('cascade');
            $table->foreign('medicine_batch_detail_id')->references('id')->on('medicine_batch_details')->onDelete('cascade');
